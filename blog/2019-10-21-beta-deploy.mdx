...
We rolled out the [Beta update]({% post_url 2019-10-18-beta-deploy%}) over the weekend and it
appears to have helped some, but a number of issues were discovered that caused unneeded network
load, slowing down blocks and elections.
