...
The [PoC v5 update](https://engineering.helium.com/2019/12/17/poc-v5.html) exposed a few edge cases
in [blockchain-core](https://github.com/helium/blockchain-core) related to Uber's
[H3](https://github.com/uber/h3) library. The `grid_distance` function in H3 can crash in the
following scenarios:
