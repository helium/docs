...
[Recently](https://engineering.helium.com/2020/04/23/collapse.html), we mentioned that we had some
pending speedups to our HBBFT implementation. This image releases them to the cluster.
