...
- **Fri Jun 25 08:30:00 PM PDT 2021**
  ...
  [896680](https://explorer-old.helium.com/blocks/896680) to unstick the chain and continue to
  monitor. Rewards between 4 PM PST - 8:20 PM PST are never minted and chain variable `max_open_sc`
  is lowered from `10` to `5` to reduce potential size of the next election block containing reward
  transaction.
