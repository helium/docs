...
We've added StakeJoy API support to the Helium App. StakeJoy provides data to
explorer-old.helium.com and now the Helium app to provide users with an improved experience. To use
StakeJoy, go to **Settings**, tap **Choose API Provider** and select **StakeJoy**.
