...
[June 16, 2023 - Foundation Console DC Usage](https://docs.helium.com/devblog/2023/06/16/foundation-console-dc-usage)
...
transfers when the user's balance can't cover them. Impact While this fix is specific to Foundation
Console, it further eliminates potential avenues for exploitation. The Core Developers remain
committed to ensuring the consistent and fair operation of the Helium IoT Network.
