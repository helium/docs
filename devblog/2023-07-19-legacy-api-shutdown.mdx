...
a requestor-pays basis on AWS in the `foundation-helium-l1-archive` bucket. In total this bucket is
1.4 TB. If demand is high, alternate delivery methods like IPFS or a torrent for this data can be
explored to avoid AWS egress fees.
