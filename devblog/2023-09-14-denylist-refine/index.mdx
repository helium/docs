...
In early August Nova Labs [posted a change]() in how the denylist is operated. This change has
resulted in several positive effects on the network in terms of the number of hotspots that were
improved and cleared from the denylist, as well as clusters of misbehaving hotspots getting turned
off, clearing innocent hotspots that were swept up in the analysis.
...
- **Terrain Intersection Margin**: A hotspot is added to the deny list when greater than 50 percent
  ...
  [described here](/devblog/2023/08/07/denylist-evolution/#terrain-aware-signal-verification)
...
- **Distance Insensitivity**: A hotspot is added to the deny list when the distance insensitivity is
  ...
  [here](/devblog/2023/08/07/denylist-evolution/#witness-distance-sensitivity-measurement) is above
  50 percent.
