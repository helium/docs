...
2023–12-20. This will cause increased emissions to the escrow, which will fill the underfunding.
Unfortunately, this will also increase the circulating supply of MOBILE by `274m`. While this is
substantially less than the unemitted rewards for oracles and service providers and does not affect
max supply of MOBILE, it is still a deviation from expected total emissions by at most 0.12%.
