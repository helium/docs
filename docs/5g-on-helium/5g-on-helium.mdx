...
further modifiled the emission schedule and started the programatic minting of MOBILE as follows:

<div>
  <div class="row emmisions-table">
    <div class="col col--2" style={{ marginBottom: 0 }}>
      <p></p>
    </div>
    <div class="col col--5" style={{ marginBottom: 0 }}>
      <p>BEFORE: HIP-53 Emissions Schedule</p>
    </div>
    <div class="col col--5" style={{ marginBottom: 0 }}>
      <p>AFTER: HIP-75 Emissions Schedule</p>
    </div>
  </div>
</div>
<div class="row emmisions-table">
