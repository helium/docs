...
by the MOBILE PoC Oracle over the previous `6` tests, depending on the availability of the data.
This moving average is reset following a speed test gap of `>12 hours` and a minimum of `2` Speed
Test results are required to be eligible for Genesis Rewards.
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    <div class="col col--6" style={{ marginBottom: 0 }}>
      <b>Not Eligible</b>
      <p>
        This 5G Hotspot <b>will not</b> be eligible for rewards during the Reward Periods for which
        the results of Test 1 is most recent as there is not enough data to calculate a Moving
        Average.
      </p>
    </div>
    <div class="col col--6" style={{ marginBottom: 0 }}>
      <b>Eligible</b>
      <p>
        This 5G Hotspot <b>will</b> be eligible for rewards during the Reward Periods for which the
        results of Test 2 or later are most recent.
      </p>
    </div>
  </div>
</div>
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      <p>
        This 5G Hotspot <b>will not</b> be eligible for rewards during the Reward Periods for which
        the results of Test 1 or 8 are the most recent as there is not enough data to calculate a
        Moving Average.
      </p>
      <p>
        This 5G Hotspot <b>will not</b> be eligible for rewards during the Reward Periods for which
        the results of Test 5 and 6 are the most recent as a missed Speed Test resets the Moving
        Average.
      </p>
    </div>
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      <p>
        This 5G Hotspot <b>will</b> be eligible for rewards during the Reward Periods for which the
        results of Tests 2 through 4 and Tests 7 through 12 are the most recent.
      </p>
    </div>
  </div>
</div>
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      <p>
        This 5G Hotspot <b>will not</b> be eligible for rewards during the Reward Periods for which
        the results of Test 5, 6, or 7 are the most recent as there are missing Speed Test data.
      </p>
    </div>
    <div class="col col--6" style={{ marginBottom: 0 }}>
      <b>Eligible</b>
      <p>
        This 5G Hotspot <b>will</b> be eligible for rewards during the Reward Periods for which the
        results of Tests 2 through 4 and Tests 9 through 12 are the most recent.
      </p>
    </div>
  </div>
</div>
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    ...
    <div class="col col--6" style={{ marginBottom: 0 }}>
      <b>Eligible</b>
      <p>
        This 5G Hotspot <b>will</b> be eligible for rewards during all Reward Periods after Test 2.
      </p>
    </div>
  </div>
</div>
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      <p>
        This 5G Hotspot <b>will not</b> be eligible for rewards during the Reward Periods for which
        the results of Tests 6 through 8 are the most recent as at least one Speed Test metric has
        failed.
      </p>
    </div>
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      <p>
        This 5G Hotspot <b>will</b> be eligible for rewards during the Reward Periods for which the
        results of Tests 2 through 5 and Tests 9 through 12 are the most recent.
      </p>
    </div>
  </div>
</div>
