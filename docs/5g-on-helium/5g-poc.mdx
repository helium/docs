...
over the previous `6` tests. This moving average is reset following a speed test gap of `>12 hours`
and a minimum of `2` speed test results are required to be eligible for Genesis Rewards.
...
> - Reward submission occurs approx 15 minutes after the Reward Period ends, around 00:00 UTC.
> - 5G Hotspots perform periodic speed tests which will be considered in reward calculations.
> - 5G Hotspots must generate 1 "heartbeat" in a 1 hour period for at least 12 periods to ensure it
>   is providing reliable coverage uptime.

In addition to speed test requirements, a 5G Hotspot is required to generate at least 1 "heartbeat"
per hour in each of at least 12 unique hours in the Reward Period.
