...
by the Rewards Server over the previous `6` tests. This moving average is reset following a speed
...
**Successful Speed Test Series:**

Here all Speed Test Metrics are passing, the 5G Hotspot is providing a high quality connection.

<img className="docsheader" src={useBaseUrl('img/5g-on-helium/speed-test-success.png')} />

**Missing A Single Speed Test:**

This 5G Hotspot has not reported Speed Test data, this will be common for a newly connected 5G
Hotspot. This 5G Hotspot _will_ be rewarded for all Reward Periods.

<img className="docsheader" src={useBaseUrl('img/5g-on-helium/speed-test-one-miss.png')} />

**Missing Multiple Speed Tests:**

This 5G Hotspot has not reported a series of Speed Test data, this is often a result of a 5g Hotspot
being disconnected from the internet for a long time. This 5G Hotspot _will not_ earn rewards during
while Test 5 and 6 are the most recent.

<img className="docsheader" src={useBaseUrl('img/5g-on-helium/speed-test-many-miss.png')} />

**Failing A Speed Test:**

This 5G Hotspot has "failed" its Speed Test on all metrics (orange cells), but the Moving Average
(light green cells) stays within the passing range. This 5G Hotspot _will_ be rewarded for all
Reward Periods.
...
This 5G Hotspot has failed many Speed Tests in a row (orange cells), this has caused the Moving
Average to fail (light green cells). This 5G Hotspot _will not_ earn rewards during while Test 6, 7,
and 8 are the most recent.
