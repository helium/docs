...
- **Stage 1: ** Genesis Rewards
  - Genesis Phase 1:
    ...
    ** (current)**
  - Genesis Phase 2:
    [Time Period Triggered Rewards with Minimum Delay](/5g-on-helium/5g-poc#genesis-phase-1-time-period-triggered-rewards-with-minimum-delay)
  - Genesis Phase 3:
...
As an improvement to this approch, 
