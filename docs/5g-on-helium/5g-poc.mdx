...
previous `6` tests. This moving average is "reset" following a speed test gap of `>12 hours` and a
minumum of `2` speed test results are required to be eligible for Genesis Rewards.
