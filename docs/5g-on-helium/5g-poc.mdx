...
Test 2 or later are most recent.
...
This 5G Hotspot **will** be eligible for rewards during the Reward Periods for which the results of
Tests 2 through 4 and Tests 7 through 12 are the most recent.

**Not Eligible**

This 5G Hotspot **will not** be eligible for rewards during the Reward Periods for which the results
of Test 1 or 8 are the most recent as there is not enough data to calculate a Moving Average.

This 5G Hotspot **will not** be eligible for rewards during the Reward Periods for which the results
of Test 5 and 6 are the most recent as a missed Speed Test resets the Moving Average.
...
This 5G Hotspot **will** be eligible for rewards during the Reward Periods for which the results of
Tests 2 through 4 and Tests 9 through 12 are the most recent.
...
This 5G Hotspot **will not** be eligible for rewards during the Reward Periods for which the results
of Test 5, 6, or 7 are the most recent as there are missing Speed Test data.
...
This 5G Hotspot **will** be eligible for rewards during all Reward Periods after Test 2.
...
This 5G Hotspot **will** be eligible for rewards during the Reward Periods for which the results of
Tests 2 through 5 and Tests 9 through 12 are the most recent.
...
This 5G Hotspot **will not** be eligible for rewards during the Reward Periods for which the results
of Tests 6 through 8 are the most recent as at least one Speed Test metric has failed.
