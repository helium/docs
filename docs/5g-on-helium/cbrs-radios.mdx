...
Spectrum Access System (SAS) to operate. Please be sure to evaluate your site location and ability to
...
Refer to the 5G Hotspot dashboard for information on each connected Small Cell Radio (local network connection only)
...
GPS antenna that can be positioned independently while Outdoor Small Cell Radios have the GPS antenna
