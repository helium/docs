...
Instead of an LoRa antenna, Helium 5G Hotspots use Citizens Broadband Radio Service (CBRS) Radios to
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    ...
    <div class="col col--3" style={{ marginBottom: 0 }}>
      ...
      <p>
        The Spectrum Access was recently <code>None</code> and is comming back
