...
You can also find further CBRS radio troubleshooting guide from the Bobcat Knowledge Center: 
  
- [CBRS Radio Troubleshooting Guide](https://bobcatminer.zendesk.com/hc/en-us/articles/7282743642395-Troubleshooting-Issues-with-the-Indoor-CBRS-Small-Cell-Radio)
...
Calculate the Total Reward Units for a given epoch, by using the reward weight for every small cell
radio model.

In this example, the Total Rewards Units per epoch is 2,000 and the ratios are as follows:

```bash
  (High-Power Outdoor Count (300) * 2.0)    =>    600
+            (Outdoor Count (400) * 1.5)    =>  + 600
+             (Indoor Count (800) * 1.0)    =>  + 800
------------------------------------            ------
                                                2,000
```
