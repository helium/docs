...
- 300 High Power Outdoor 5G Hotspots earn rewards
- 400 Outdoor 5G Hotspots earn rewards
- 800 Indoor 5G Hotspots earn rewards

:::

### Total Rewards Units for Epoch

Calculate the Total Reward Units for a given epoch, by using the reward weight for every small cell radio model.

In this example, the Total Rewards Units per epoch is 2,000 and the ratios are as follows:

```bash
  (High Power Outdoor Count * 2.0)    =>    300
+            (Outdoor Count * 1.5)    =>  + 400
+             (Indoor Count * 1.0)    =>  + 800
------------------------------------      ------
                                          2,000
```
...
Each Small Cell Radio is allocated its rewards based on it's reward weight.

> Small Cell Reward = Epoch Rewards x Model Reward Weight / Total Reward Units

```bash
High Power Outdoor  => 100,000 * 2.0 / 2,000 = 100 MOBILE
Outdoor             => 100,000 * 1.5 / 2,000 = 75  MOBILE
Indoor              => 100,000 * 1   / 2,000 = 50  MOBILE
```
