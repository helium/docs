...
individual 5G Hotspot Makers. As an example, see the FreedomFi installation guides here:
...
Once the 5G Hotspot is onboarded and a Small Cell Radio are physically installed, the Small Cell
Radio will automatically initialize and aquire a GPS lock. Once that is complete, the Small Cell
Radio dashboard appear under the "Radio Dashboard" tab on the local IP address of the 5G Hotspot.
...
an automatic process of reporting to the Helium blockchain that the Small Cell Radio is online and
...
| Model           | Reward Weight | Small Cell Radio Type |
| :-------------- | :-----------: | :-------------------- |
...
- 100 High Power Outdoor 5G Hotspots earn rewards
...
In this example, the Total Emissions Weight is 1,300 and the ratios are as follows (rounded for ease
of understanding)
...
### Small Cell Radio Type Pool

Each Small Cell Radio Type is allocated its ratio of the total rewards in the given epoch.

> Small Cell Radio Type Reward Pool = Epoch Rewards \* Weighted Small Cell Radio Type Ratio
...
Each 5G Hotspot is rewarded from its respective rewards pool by Small Cell Radio Type.

> Reward Per Epoch = Small Cell Radio Type Reward Pool / Number of Small Cell Radios of that Type

```bash
High Power Outdoor  => 16,000 / 100 =  160 MOBILE per High Power Outdoor Small Cell Radio
Outdoor             => 46,000 / 400 =  115 MOBILE per Outdoor Small Cell Radio
Indoor              => 38,000 / 500 =   76 MOBILE per Indoor Small Cell Radio
```
