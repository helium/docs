...
- 1,000,000 MOBILE Rewarded per epoch
- 600 High-Power Outdoor 5G Hotspots earn rewards
- 800 Outdoor 5G Hotspots earn rewards
- 1400 Indoor 5G Hotspots earn rewards
...
Calculate the Total Reward Points for a given epoch, by using the Reward Weight for every small cell
radio type.

In this example, the total rewards Points per epoch is 4,000 and the ratios are as follows:

```bash
  (High-Power Outdoor Count (  600) * 4.0)    =>    1,600
+            (Outdoor Count (  800) * 2.5)    =>  + 2,000
+             (Indoor Count (1,400) * 1.0)    =>  + 1,400
-------------------------------------------       --------
                                                    4,000
```
...
> Small Cell Reward = Epoch Rewards x Model Reward Weight / Total Reward Points

```bash
High-Power Outdoor  => 1,000,000 * 4.0 / 4,000 = 1000 MOBILE
Outdoor             => 1,000,000 * 2.5 / 4,000 =  625 MOBILE
Indoor              => 1,000,000 * 1.0 / 4,000 =  250 MOBILE
```
