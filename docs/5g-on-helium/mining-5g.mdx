...
More details on weighting will be added to this document in the future.
...
The Helium Foundation will work with the core developers to begin the Genesis period of MOBILE rewards. This will be paid out of the Foundation's pre-mined MOBILE rewards pool. The rate of rewards, as defined above, is half that defined in HIP 53 and will be proportionally distributed to all active 5G radios as described below.
