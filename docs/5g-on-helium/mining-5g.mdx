...
There will be a max supply of 250B (billion) MOBILE with issuance halvenings of every 2 years aligned with the
...
Currently, the Helium Foundation intends to issue 100M (million) tokens per day in the Genesis period, and it
