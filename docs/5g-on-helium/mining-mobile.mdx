...
Begining in [Genesis Phase 3](./mobile-poc##speed-test-tier-reward-scaling) 5G Hotspots perform
Speed Tests that impact Rewards Scaling Multipliers in addition to Small Cell Type.
