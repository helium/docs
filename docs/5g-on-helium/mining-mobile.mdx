...
slug: /5g-on-helium/mining-mobile
---
...
Several factors contribute to how much MOBILE a 5G Hotspot will earn over a given period, there are
some higher-level concepts, design elements, and rules to keep in mind that will help better explain
what you might earn and why. This section covers these, as well as some mining and token reward
basics.
...
5G Hotspot will appear on [explorer.helium.com](https://explorer.helium.com/) within 5 days,
...
Begining in [Genesis Phase 3](./mobile-poc#genesis-phase-3-speed-tests-and-quality-of-service) 5G
Hotspots perform Speed Tests that impact Rewards Scaling Multipliers in additoin to Small Cell Type.
