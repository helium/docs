...
<Tabs block={true}>
<TabItem value="all_acceptable" label="✅ Example 1: All Acceptable" default>
...
<TabItem value="degraded upload" label="❎ Example 2: Degraded Upload" default>
...
<TabItem value="poor_download_degraded_upload" label="⛔️ Example 3: Poor Download" default>
...
<TabItem value="failed_latency" label="🚫 Example 4: Failed Latency" default>
