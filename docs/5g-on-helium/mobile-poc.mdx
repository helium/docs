...
:::caution Current Explorer Statistics View
...
**Before Speed Tests are incorporated into Rewards calculations, the Explorer will be updated to
show the results of the Moving Average for each metric. See Examples of possible results below.**
