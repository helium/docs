...
title: Service Providers on the Helium 5G Network
sidebar_label: Service Providers
slug: /5g-on-helium/service-providers
---
...
token emissions and through Helium 5G data accessed by their subscribers.
...
created the “People’s carrier” category, an innovative mobile carrier model that leverages
people-built coverage and crypto-economics to reduce costs and increase benefits for subscribers.
...
Programmatic economic coordination executed through Smart Contracts replace middle managers
...
subscribers. Regardless, Service Providers have more autonomy and growth potential than offered in
the otherwise rigid economic model of the traditional carrier.
