...
## List Richest Accounts [DEPRECATED]
...
## Account for Address [DEPRECATED]
...
## Hotspots for Account [DEPRECATED]
...
## Validators for Account [DEPRECATED]
...
Fetches transactions that indicate activity for an account. This includes any transaction that
involves the account, usually as a payer, payee or owner.

You may optionally add a transaction type filter. For example: `activity?filter_types=rewards_v2`
will provide reward transactions only.
...
## Roles Counts for Account [DEPRECATED]
...
## Elections for Account [DEPRECATED]
...
## Challenges for Account [DEPRECATED]
...
## Pending Transactions for Account [DEPRECATED]
...
## Rewards for an Account [DEPRECATED]
...
## Rewards in a Rewards Block for an Account [DEPRECATED]
...
## Reward Totals for an Account [DEPRECATED]
