...
Use this API to list DC burn events. Events include a block, amount, type of
burn, and the address of the account the DC were burned out of. The oracle price
that was active at the point the DC burn happened is also listed to enable
calculating how much HNT the burned DC represents.
