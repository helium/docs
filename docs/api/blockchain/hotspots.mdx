...
<Tabs
  ...
  defaultValue="roles"
  values={[
    { label: "Roles (activity_v2)", value: "roles" },
    { label: "Legacy (activity_v1)", value: "activity" },
  ]}
>
<TabItem value="roles">
...
:::caution
This activity route will be deprecated on May 1, 2022 and will be replaced by Roles
:::
