...
```
GET https://staging-console.helium.wtf/api/v1/integrations?name=your_integration_name
```
...
```
GET https://staging-console.helium.wtf/api/v1/flows?integration_id=your_integration_id
```
...
```
PUT https://staging-console.helium.wtf/api/v1/devices/active?dev_eui=your_dev_eui
```
