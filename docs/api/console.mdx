...
Create prebuilt integration for integration providers planning to offer
...
Creates a custom HTTP integration. Use the Console UI for JSON message
templates.
...
Create a prebuilt integration for partners providing a connectivity as a service
solution.
