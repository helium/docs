...
[using a miner section](/setup-a-packet-forwarder). Docker's `exec` command enables this e.g.
...
[using a miner section](/setup-a-packet-forwarder)). Or create an alias such as:
