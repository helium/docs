...
Before launching the Miner, you will want to configure ports on your network to forward the port:
...
"Forwarding" is less relevant if you are running a radio packet forwarder on the
