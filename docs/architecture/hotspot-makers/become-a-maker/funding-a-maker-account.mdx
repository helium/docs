...
[^1]:
    ...
    Helium Mobile network. Onboarding a MOBILE Hotspot is an additional SOL fee as all CBRS MOBILE
    Hotspots were also IOT Hotspots. The Maker App can be configured to do both, either or just one
    of the network onboards.
