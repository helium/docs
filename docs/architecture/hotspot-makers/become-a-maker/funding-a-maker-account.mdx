...
[^1]:
    CBRS Mobile Hotspots can still be onboarded but can no longer be enabled to operate on the 
    Helium Mobile network. Onboarding a MOBILE Hotspot is an additional SOL fee as all CBRS 
    MOBILE Hotspots were also IOT Hotspots. The Maker App can be configured to do both, either 
    or just one of the network onboards.

### Data Credit Fees

These tokens are "burned".

|                              | IOT Hotspot Fee        | MOBILE CBRS Hotspot Fee<sup>(</sup>[^1]<sup>)</sup> |
| ---------------------------- | ---------------------- | ---------------------------------------------- |
| Onboarding Fee               | 1,000,000 DC ($10 USD) | 4,000,000 DC ($40 USD)                         |
| First Location Assertion Fee | 100,000 DC ($1  USD)   | 1,000,000 DC ($10 USD)                         |
| **Total**                    | **1,100,000 DC**       | **5,000,000 DC**                               |
