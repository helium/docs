...
As a stable price feeds became available, community-sourced price feeds were removed in favor of
Pyth.
...
- ~~[IOT Price Oracle](https://explorer.solana.com/address/iortGU2NMgWc256XDBz2mQnmjPfKUMezJ4BWfayEZY3/anchor-account)~~
  Handled by [Pyth IOT-USD](https://pyth.network/price-feeds/crypto-iot-usd) as of March 5, 2024.
