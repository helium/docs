...
The Helium Program Library (HPL) is a collection of smart contracts that enable the Helium Network
to operate on the Solana blockchain. The HPL is designed to be a comprehensive resource for
developers looking to build on the Helium Network, providing a suite of smart contracts and tools to
facilitate the seamless integration of the Helium Network with the Solana blockchain.
...
- **Solana Programs**: The HPL provides a comprehensive suite of programs designed to facilitate the
  seamless operation of the Helium Network on the Solana blockchain. These smart contracts are
  designed to be easily accessible and customizable, allowing developers to build on the Helium
  Network with ease.
...
tutorials, and examples to help developers get started with building on the Helium Network.
Developers can also access the HPL smart contracts and tools to facilitate the seamless integration
of the Helium Network with the Solana blockchain.
