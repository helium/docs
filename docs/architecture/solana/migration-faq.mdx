...
transactions, enough for roughly 100 transactions. The amount of SOL needs to be topped up and we
recommmend 0.1 SOL and keeping it above 0.02 or Hotspot, Token exchange, staking and voting 
transactions attempted on the blockchain may fail. 
...
IOT can be swapped for HNT in the Helium Wallet app or on an exchange. Find more info about IOT
...
Always check the swap or exchange rate before confirming a transaction. You are responsible for the
confirmation. The default floor rate may not be the best exchange rate available.
