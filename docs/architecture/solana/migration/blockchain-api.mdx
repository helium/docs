...
The existing [Helium API](/archive/api/blockchain/introduction) will serve only information up to
the chain halt at the time of migration. Knowing that some users will continue to rely on historical
data, The Helium Foundation has formed an agreement with the API provider, BlockJoy, to continue
hosting this API following the migration.
