...
**Step 1: Monitor the Migration Status**
Stay informed throughout the migration process via Twitter and Discord. The migration is scheduled to commence at 16:00:00 UTC on April 18. Following the migration, validators can be safely shut down upon communication from core developers after 16:00:00 UTC on April 19. Subsequently, validators will cease block production for the Helium Network and will no longer receive HNT rewards.

**Step 2: Access Your Staked HNT**
Ensure access to your staked validators by transferring wallets into the Helium Wallet App if you haven't already done so. Post-migration, your staked HNT will seamlessly transition to veHNT, securely held within your Wallet's custody. Ownership of veHNT will be represented by a non-transferable Solana NFT housed within your Wallet.

For validators staked with HNT on a Ledger device, follow the steps outlined in the [Ledger Migration Guide](/solana/migration/ledger) to migrate your Ledger Wallet.

**Step 3: Automatic Conversion to veHNT**
On April 18, 2023, all validators still staked or in cooldown will undergo automatic conversion to veHNT, as per the specifications outlined in HIP-70. Each validator will receive 375,000 veHNT, constituting a six-month staking position with a rolling lock-up mechanism termed "constant lock-up."

**Step 4: Delegation to SubDAOs**
Determine the preferred subDAO or combination thereof ([IOT](/tokens/iot-token) and [MOBILE](/tokens/mobile-token)) to which you wish to delegate your veHNT. You have the flexibility to allocate multiple veHNT positions to different subDAOs or for varying lock-up durations. Each veHNT position can be fully or partially delegated as per your discretion.
...
Effective February 2, 2023, with the introduction of Oracle Based PoC, Validators no longer assume the Challenger role, as Hotspots autonomously commence beaconing. Consequently, the rewards pool for PoC Challengers has reverted to Hotspots.

Following the implementation of HIP-70 and the L1 transition, incumbent Validators will cease block production for the Helium Network and forfeit HNT rewards. Upon conversion of their staked HNT to veHNT, holders have the option to delegate to specific subDAOs.

Presently, the IOT and MOBILE subDAOs allocate a 6% token emission pool for veHNT stakers.

Post-implementation of HIP-51, HIP-52, and HIP-53, all subDAOs collectively receive non-HST emissions of HNT, amounting to 68% of the emitted HNT, which will increase to 69% in the subsequent yearly emissions change slated for August 2023. This emissions curve undergoes annual adjustments, ultimately culminating in subDAOs receiving 85% of all future HNT emissions.

Previously, Validator stakers participated in a performance-based randomized chance mechanism entitling them to 6% of the daily HNT distribution. However, under the current framework, they are entitled to a share of 6% of the 68% of the HNT distributed to subDAOs, contingent upon the amount of HNT staked and the duration of lock-up.
...
Each validator will be granted 375,000 veHNT, constituting a veHNT position for a duration of six months with a rolling lock-up mechanism, referred to as "constant lock-up."

This calculation is derived from multiplying 10,000 HNT by a 12.5 multiplier, accounting for the six-month lock-up period, and further multiplied by 3 to incorporate the Landrush bonus for early veHNT investors.

If you possess multiple validators, you will receive all veHNT allocations consolidated into a single substantial veHNT position.
...
If a validator owner takes no action, the stake will seamlessly convert to veHNT automatically.

Each validator owner will receive 375,000 veHNT per validator directly into their Wallet, consolidated as a single position. This position will remain unencumbered by any automatic cooldown period. It will only enter the cooldown phase upon the owner's initiation. Once cooldown is selected, the owner will reclaim their original 10,000 HNT per validator stake after a 183-day (6-month) interval from the date of cooldown selection.

Post-transition, validators will cease to accrue any HNT rewards. To earn rewards in IOT or MOBILE tokens, validator stakes must be delegated to either the IOT or MOBILE subDAO. Additionally, stakes can be allocated across multiple subDAOs as per the owner's preference.
