...
1. Access to your validator's Wallet, either through the Helium Wallet App or a Ledger hardware
   wallet.
1. Familiarized yourself with the new [veHNT](/vehnt) governance model and the concept staking to
   subDAOs (IOT and MOBILE).
...
Delegation of veHNT can be managed within the [Helium Wallet App](/helium-wallet-app) using Realms.
