...
necessarily onboard Mobile Hotspots. Each subnetwork must approve makers to issue rewardable
entities.
...
Rewards for locking tokens will happen in transactions combining up to 4 days of rewards.
