...
Rewardable entities like Helium Hotspots are represented on the Solana blockchain by a further 
development of NFTs called [Compression NFTs](compression-nfts)(cNFTs).
