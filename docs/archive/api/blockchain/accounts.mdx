...
slug: /archive/api/blockchain/accounts
---
...
As part of the Solana Migration, these API endpoints will no longer be updated or provide live data.
These endpoints may be accessible for a limited time following the Migration as a reference to
historical Helium blockchain data.
