...
<img className="docsheader" src={useBaseUrl('img/archive/blockchain/mining.png')} />
...
[Chain Variables API](/archive/api/blockchain/chain-variables). The next maximum allotted rewards
change is currently scheduled for **August 1, 2023** and will be updated along with changes related
to the havening to maintain max HNT supply.
