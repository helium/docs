...
slug: /network-iot/console/coverage
---
...
[here](/network-iot/console/profiles/) and choose to purchase all packets. Assuming there is
...
<img src={useBaseUrl('img/network-iot/console/coverage-alias.png')} />
...
`My Hotspot` list check [here](/network-iot/console/coverage/#identify-hotspots-that-hear-devices).
