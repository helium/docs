...
[here](/archive/console/profiles/) and choose to purchase all packets. Assuming there is sufficient
Data Credit balance, Console will purchase packets from all the Hotspots that heard the device and
display them.
...
`My Hotspot` list check [here](/archive/console/coverage/#identify-hotspots-that-hear-devices).
