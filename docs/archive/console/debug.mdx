...
slug: /network-iot/console/debug
---
...
<img src={useBaseUrl('img/network-iot/console/console-debug-waiting.png')} />

Once packets are received or sent down to your device, you will see them display immediately in the
Debug window, seen here:

<img src={useBaseUrl('img/network-iot/console/console-debug-event.png')} />
