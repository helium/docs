...
slug: /network-iot/console/integrations/adafruitio
---
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-select-adafruitio.png')} />
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-adafruitio-mykey.png')} />

You will then be presented with both your username and key as shown below.

<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-adafruitio-get-user-key.png')}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-adafruitio-enter-user-key.png',
  )}
/>
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-adafruitio-label.png')} />
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-adafruitio-choose-decoder.png',
  )}
/>
