...
slug: /network-iot/console/integrations/aws-iot-core
---
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-select-aws-iot-core.png')}
/>
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-aws-iot-core-iam.png')} />

We are now going to create a new **User:**

<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-aws-iot-core-new-user.png')}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-aws-iot-core-new-user-details.png',
  )}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-aws-iot-core-new-user-attach-policy.png',
  )}
/>

<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-aws-iot-core-new-user-success.png',
  )}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-aws-iot-core-enter-details.png',
  )}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-aws-iot-core-find-services.png',
  )}
/>
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-aws-iot-core-monitor.png')}
/>
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-aws-iot-core-things.png')}
/>
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-aws-iot-core-interact.png')}
/>

<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-aws-iot-core-topics.png')}
/>
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-aws-iot-core-mqtt-client.png')}
/>

<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-aws-iot-core-mqtt-message.png',
  )}
/>
