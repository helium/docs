...
slug: /network-iot/console/integrations/azure
---
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-add-helium-console.png')} />

Choose the **Azure IoT** integration icon.

<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-azure-helium-console.png')}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-azure-iot-central-id-scope.png',
  )}
/>
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-azure-iot-central-icon.png')}
/>
...
More information about Flows [here](/network-iot/console/flows/).

:::important

Decoding of sensor data must occur prior to sending data to Azure IoT Central. More information on
Decoder Functions [here](/network-iot/console/functions#creating-a-decoder-function).
