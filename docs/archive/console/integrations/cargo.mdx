...
slug: /network-iot/console/integrations/cargo
---
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-select-cargo.png')} />
...
of a [Function Decoder](/network-iot/console/functions/) on Console in order to decode the device
payload before sending it to Cargo. The accepted fields are listed below and can be located at any
depth within the `decoded` field.
