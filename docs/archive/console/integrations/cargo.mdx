...
<img src={useBaseUrl('img/network-iot/integrations/integrations-select-cargo.png')} />
...
of a [Function Decoder](/archive/console/functions/) on Console in order to decode the device
