...
<img src={useBaseUrl('img/network-iot/integrations/integrations-http-request-bin.png')} />

... and paste it in Console's **Endpoint URL** field.

<img src={useBaseUrl('img/network-iot/integrations/integrations-http-details.png')} />
...
[JSON Schema](/archive/console/integrations/json-schema) to understand how to parse data received.
...
<img src={useBaseUrl('img/network-iot/integrations/integrations-http-downlink-details.png')} />
...
[here](/archive/console/integrations/json-schema#downlink-transmitting-data-to-a-device).
...
<img src={useBaseUrl('img/network-iot/integrations/integrations-http-downlink-button.png')} />
...
<img
  src={useBaseUrl('img/network-iot/integrations/integrations-http-downlink-tool-expanded.png')}
/>

Once you have initiated the downlink, you should see the downlink event show in the event log, as
shown below.

<img src={useBaseUrl('img/network-iot/integrations/integrations-http-downlink-event.png')} />
...
<img
  src={useBaseUrl('img/network-iot/integrations/integrations-http-downlink-postman-example.png')}
/>
...
creating a [decoder function](/archive/console/functions) for brevity.
