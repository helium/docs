...
slug: /network-iot/console/integrations/http
---
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-http-request-bin.png')} />

... and paste it in Console's **Endpoint URL** field.

<img src={useBaseUrl('img/network-iot/console/integrations/integrations-http-details.png')} />
...
[JSON Schema](/network-iot/console/integrations/json-schema) to understand how to parse data
received.
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-http-downlink-details.png')}
/>
...
[here](/network-iot/console/integrations/json-schema#downlink-transmitting-data-to-a-device).
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-http-downlink-button.png')}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-http-downlink-tool-expanded.png',
  )}
/>
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-http-downlink-event.png')}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-http-downlink-postman-example.png',
  )}
/>
...
creating a [decoder function](/network-iot/console/functions) for brevity.
