...
slug: /network-iot/console/integrations/mqtt
---
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-select-mqtt.png')} />
...
[JSON schema documented here.](/network-iot/console/integrations/json-schema)
