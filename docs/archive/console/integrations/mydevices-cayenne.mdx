...
slug: /network-iot/console/integrations/mydevices-cayenne
---
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-mydevices-cayenne-title.png')}
/>
...
<img src={useBaseUrl('img/network-iot/console/integrations/integrations-select-mydevices.png')} />
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-mydevices-cayenne-add-new.jpg',
  )}
/>
...
<img
  src={useBaseUrl('img/network-iot/console/integrations/integrations-mydevices-cayenne-search.png')}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-mydevices-cayenne-select-st.png',
  )}
/>
...
<img
  src={useBaseUrl(
    'img/network-iot/console/integrations/integrations-mydevices-cayenne-device-details.png',
  )}
/>
