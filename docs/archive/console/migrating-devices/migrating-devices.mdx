...
slug: /network-iot/console/migrating-devices
---
...
- [Importing TTN Devices with Console Tool](/network-iot/console/migrating-devices/ttn-import)
- [Manually Migrating Devices from TTN](/network-iot/console/migrating-devices/ttn-manual)
