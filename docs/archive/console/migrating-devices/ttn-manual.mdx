...
want to try the [Command-Line Interface for automated import](/archive/console/cli#ttn-import).
...
<img src={useBaseUrl('img/network-iot/migrating-devices/ttn-manual-keys.png')} />

<img src={useBaseUrl('img/network-iot/migrating-devices/ttn-manual-console.png')} />
