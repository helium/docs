...
slug: /network-iot/console/migrating-devices/ttn-manual
---
...
want to try the [Command-Line Interface for automated import](/network-iot/console/cli#ttn-import).
...
<img src={useBaseUrl('img/network-iot/console/migrating-devices/ttn-manual-keys.png')} />

<img src={useBaseUrl('img/network-iot/console/migrating-devices/ttn-manual-console.png')} />
