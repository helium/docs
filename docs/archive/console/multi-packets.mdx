...
<img src={useBaseUrl('img/network-iot/multiple-packets.png')} />- Click the Add **+** icon.{' '}

{" "}

<img src={useBaseUrl('img/network-iot/multiple-packets1.png')} />
...
<img src={useBaseUrl('img/network-iot/flows-inspector-packets.png')} />
