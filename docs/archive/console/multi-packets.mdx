...
slug: /network-iot/console/multi-packets
---
...
<img src={useBaseUrl('img/network-iot/console/multiple-packets.png')} />- Click the Add **+**
icon.{' '}

{" "}

<img src={useBaseUrl('img/network-iot/console/multiple-packets1.png')} />
...
<img src={useBaseUrl('img/network-iot/console/flows-inspector-packets.png')} />
