    ...
    <div class="col col--12">
      <div class="flex">
        ...
        <div className="headertext">
          ...
          <div>
            <a href="/hotspot-makers/iot/full-hotspots">
...
<div class="container" style={{ padding: 0 }}>
  <div class="row">
    ...
    <div class="col col--5 col--offset-1 " style={{ marginBottom: 100 }}>
      ...
      <a className="block" href="/hotspot-makers/iot/full-hotspots">
      ...
      <a className="block" href="/hotspot-makers/iot/data-only-hotspots">
    ...
    <div class="col col--6 borderTop">
      <div>
        ...
        <p style={{ marginBottom: 40 }}>
          ...
          <a href="https://docs.helium.com/hotspot-makers/iot/full-hotspots">can be found here</a>.
        </p>
      </div>
    </div>
    <div class="col col--6 borderTop">
      <div>
        ...
        <p style={{ marginBottom: 40 }}>
          ...
          <a href="https://docs.helium.com/hotspot-makers/iot/light-hotspots">can be found here</a>.
        </p>
      </div>
    </div>
    <div class="col col--6 borderTop">
      <div>
        ...
        <p style={{ marginBottom: 40 }}>
          ...
          <a href="https://docs.helium.com/hotspot-makers/iot/data-only-hotspots">
            can be found here
          </a>
          .
        </p>
