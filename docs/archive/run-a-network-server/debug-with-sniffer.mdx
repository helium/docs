...
Log on to Console, and [create a new device](/archive/console/adding-devices/).
...
Consider making changes to settings within [configuration profiles](/archive/console/profiles/) in
Console for this device, such as `rx_delay`.
