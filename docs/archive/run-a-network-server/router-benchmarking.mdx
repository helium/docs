...
[Generate a Console API Key](/network-iot/console/my-account/#console-api-keys), which requires
...
[cost of adding data-only hotspots and asserting location](/network-iot/hotspots-iot/data-only-hotspots)
of each.
...
and then confirm asserted locations via [blockchain API](/archive/api/blockchain/introduction/):
...
your wallet; see [Data Credits](/data-credit) within Console documentation.
