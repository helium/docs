...
[Generate a Console API Key](/archive/console/my-account/#console-api-keys), which requires logging
onto Console user interface (UI). Everything else will be done by command-line interface (CLI).
