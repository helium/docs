...
Many fees benefit from implicit burn, including when paying for OUIs and DevAddr's (done previously
when you purchased an OUI, but your router needs a DC balance to run.
