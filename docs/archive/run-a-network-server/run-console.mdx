...
- have a fully sync'ed Miner or ETL instance to extract a snapshot from. To learn how to setup a
  Miner, [please read here](/network-iot/setup-a-packet-forwarder).
...
[implicit burn](/network-iot/transaction-fees#transaction-fees-and-implicit-burn), including when
paying for OUIs and DevAddr's (done previously when you purchased an OUI, but your router needs a DC
balance to run.
