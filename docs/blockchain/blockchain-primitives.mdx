...
[Helium Mobile App](/wallets/app-wallet) also shows block details. Developers can also use the
...
| `coinbase data credits`            | Created the initial 10,000 DCs required to bring the first group of Miners online.                                                                                                                                                                                                                                        |
...
| `multi-payment`                    | Used to send Tokens from one wallet to multiple wallets.                                                                                                                                                                                                                                                                  |
| `OUI`                              | Create an Organization Unique Identifier (OUI) for a new router on the Helium network. In the Helium blockchain, Miners forward packets to Routers that own them based on their OUI as stored in the blockchain.                                                                                                          |
| `payment`                          | Used to send Tokens from one wallet to another.                                                                                                                                                                                                                                                                           |
...
| `rewards`                          | Bundles multiple reward transactions at the end of each epoch and distributes all Tokens produced in that block to wallets that have earned them.                                                                                                                                                                         |
...
- If you’re using the [Helium Wallet App](/wallets/helium-wallet-app) (iOS, Android), your private
  key is encrypted locally (and can be recreated on another mobile device using the 12-word or
  24-word passphrase generated when your wallet was first created);
