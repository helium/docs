...
The Helium blockchain currently has 20 native transaction types. Some appear in nearly every block mined while others were created to be used only once and will never heard from again. (You can see various transaction types in action using the [Helium Blockchain Explorer](https://explorer.helium.com/).
