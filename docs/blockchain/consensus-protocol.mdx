...
title: The Helium Consensus Protocol
pagination_label: The Helium Consensus Protocol
sidebar_label: The Helium Consensus Protocol
description: The Helium Consensus Protocol
...
A new Consensus Group is elected once per epoch. Currently there are `43` members elected to each
consensus group, as defined in the `num_consensus_members` chain variable.
...
- Successful participation in proof of coverage as a beaconer
- Witnessing a proof of coverage beacon
