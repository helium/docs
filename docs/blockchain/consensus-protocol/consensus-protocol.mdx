...
implementation, a consensus group of [elected Validators](https://explorer-beta.helium.com/validators) receives encrypted
...
For a more complete overview of how Validators are elected to the consensus group, see the [Election Process Documentation](/mine-hnt/validators/penalties/#the-election-process)
...
During the course of any epoch, Validators are rewarded for the following list of activities per changes from [HIP 55](https://github.com/helium/HIP/blob/main/0055-validator-challenges.md):
