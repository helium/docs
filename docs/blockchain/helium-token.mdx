---
id: helium-token
title: The Helium Token
pagination_label: The Helium Token
sidebar_label: The Helium Token
description: The Helium Token
...
<!--TODO: post migration: point to pyth price feeds instead  -->
...
<!--TODO: rework for each DNT and HNT - HIP-51 content mostly  -->

## Helium Token Usage

The Helium Token is designed to serve the needs of the two primary parties in the Helium blockchain
ecosystem:

1. **Hotspot Hosts and Network Operators**. Hosts [mine HNT](/blockchain/mining) while deploying and
...
<!--TODO: integrate HIP-51 ocntent here  -->
...
<!--TODO: max supplies for DNTs goes here.  -->
...
producing `2,500,000` HNT until the next scheduled halving.
...
<!--TODO: notes on data credit costs varying within subDAOs  -->
...
Network. One Data Credit will always cost `$0.00001`. Or, `$1.00` will always buy you `100,000` Data
Credits. But, as noted above, Data Credits are produced by burning HNT. And the market price of HNT
will of course fluctuate.
