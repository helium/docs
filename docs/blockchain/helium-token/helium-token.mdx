...
## HNT Mining Schedule and Max Supply

Since the [genesis block](https://explorer.helium.com/blocks/1), the Network has mined a target of `5,000,000` HNT per month. And since the [community approval of HIP 20](https://github.com/helium/HIP/issues/73), the Helium blockchain uses a two year halvening schedule, with a maximum supply of 223,000,000 HNT. 
