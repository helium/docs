...
<!--TODO: post migration: rework for mining of IOT and split HNT rewards into separate document, HIP-51  -->
...
<!--TODO: rewards must be claimed to wallet as only user action needed  -->

## Target HNT Production Per Epoch

<!--TODO: DNT tokes per epoch updates  -->
...
<!--TODO: post migration point to new tools and dashboards  -->
...
<!--TODO: post migration update for HIP-51  -->
<!--TODO: notes on subDAO distributions  -->
...
<!--TODO: specify this applies to IOT network  -->
...
<!--TODO: post migration remove validator content  -->
...
<!--TODO: post migration: swap for IOT  -->
...
<!--TODO: add section on "what if solana goes down?"  -->
