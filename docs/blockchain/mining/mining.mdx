...
- All Hotspots participating in PoC, including `Challengees` and `Witnesses` will earn rewards
...
- `PoC Challengee` and `Witness` reward types get distributed in the epoch that includes the
