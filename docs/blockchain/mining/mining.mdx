...
Network. Hotspots are rewarded in Helium Token, HNT.
...
No. Once your Hotspot is completely deployed and fully synced with the Helium blockchain, you as the
owner are not required to do anything else in order to earn $HNT. Your Hotspot will perform all of
the above activities on its own while it runs.
...
| :-------------------- | -------------: | ------------------------: |
| PoC Challenger        |          0.85% |                   14.7569 |
| PoC Challengees       |          4.73% |                   82.1181 |
| Witnesses             |         18.92% |                  328.4722 |
| Consensus Group       |          6.00% |                  104.1667 |
| Security Tokens       |         32.00% |                  555.5556 |
...
capped at 37.50% (651.0417 HNT). Therefore, if the DC burned doesn't equal the value of `651.0417`
HNT, the remaining HNT is redistributed to the Proof of Coverage (PoC) rewards groups pro-rata.
