...
| :-------------------- | :---------------------------------------------------------------------------------------------------------------- |
| PoC Challenger        | Rewarded to any Validator that creates a valid PoC challenge and submits the corresponding receipt to the blockchain. |
...
No. Once your Hotspot is completely deployed, you as the owner are not required to do anything else in order to
