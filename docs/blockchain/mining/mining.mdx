...
| :-------------------- | :---------------------- | :----------------------------------------------------------------------------------------------------------------- |
| PoC Challengees       | poc_challengees_percent | Awarded to any Hotspot that transmits a PoC packet.                                                                |
| Witnesses             | poc_witnesses_percent   | Distributed to selected Hotspots that witness a beacon packet.                                                     |
...
- `PoC Challengee` and `Witness` reward types get distributed in the epoch that
...
everyone participating in the Network - Witnesses, Security Token Holders, etc. - **is
