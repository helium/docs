...
For additional details click [here](/cli/genesis)
...
For addtional details click [here](/cli/hbbft)
...
For addtional details click [here](/cli/peer)
...
For addtional details click [here](/cli/snapshot)
...
For addtional details click [here](/cli/ledger)
...
For addtional details click [here](/cli/info)
...
For addtional details click [here](/cli/trace)
...
For addtional details click [here](/cli/txn)
...
For addtional details click [here](/cli/dkg)
...
For addtional details click [here](/cli/authorize)

Missing in CLI help

## repair

For addtional details click [here](/cli/repair)
...
For addtional details click [here](/cli/print_keys)

Missing in CLI help

## Page Syntax
```
GET https://api.helium.io/v1/minercli/:rewards/sum
```

Returns the total rewards earned for all minercli over a given time range.
...
This is place holder explanation
