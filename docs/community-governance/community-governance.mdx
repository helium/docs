...
approve/reject new changes to major elements of the Network like the core blockchain, $HNT, $IOT 
...
Start new HIP ideas in the hip-discussion channel in the Improvement Proposals folder

HIPs are managed entirely from the [HIP GitHub repository](https://github.com/helium/HIP). HIP
discussion also happens in the `Improvement Proposal` folder of
...
- [Video recordings of previous community calls](https://vimeo.com/dewialliance) some are linked in the Community Call notes.
