...
Held every Wednesday at 2PM Pacific on Zoom, Helium Hacks Happy Hour (4H) covers all things
hardware, sensors, and connectivity. If you're building something on the Network and want to share,
or simply want to learn, 4H is for you.
...
For anyone who has deployed `15` or more Hotspots, you can receive the `Patron` Discord status,
Patron-exclusive Newsletter content, and custom Patron swag. To join the program, please email
patron@helium.com with proof of purchase for `15` or more of any
[community-approved Hotspot options](https://helium.com/mine).
