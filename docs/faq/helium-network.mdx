...
LoRaWAN, a wireless protocol, and have been deployed to the Helium Network. Typically these
...
reach dozens of miles or kilometers and even connect devices that are inside buildings unlike GPS and 
cellular signals.

### What kind of cryptocurrency do I earn?

Hotspot owners earn IOT tokens on the Solana Blockchain

### How do Hotspots earn IOT?

Hotspots earn IO by providing wireless coverage and transferring data from nearby devices. The more
data transferred the larger the reward. Previously hotspots used to earn HNT tokens and
