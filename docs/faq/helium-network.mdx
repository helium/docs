...
* Validate the Network - Hotspots transmit data to each other to confirm that the Network is secure and owners receive rewards when their Hotspot participates in a process called Proof of Coverage. You can learn more about Proof of Coverage [here](https://docs.helium.com/blockchain/proof-of-coverage).
