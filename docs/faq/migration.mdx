...
Simply go to [this doc](https://docs.helium.com/solana/migration/exchange/#mapping-helium-wallets-to-solana-wallets) and paste your old Helium address into the entry box and click the “Seed Wallet” button, give it a few seconds and now your wallet should be migrated over to Solana.
...
Unless your wallet already has at least .014 SOL, you won’t be able to stake until it does so.

## How can I easily swap HNT for SOL to get extra SOL into my wallet for fees?
There is another great service being provided in [this doc]((https://docs.helium.com/helium-tokens/sol-token/)).
...
## How can I fix the hotspots missing on the Helium Wallet app?
If you are missing hotspots in the Hotspots tab on the Helium Wallet, click the Filter button and select All, this should fix the missing hotspot issue.

## Why didn't my hotspot get the IOT airdrop even though it fell under the active category as defined in [this doc](https://docs.helium.com/solana/migration/hotspot-operator/#what-is-an-active-hotspot)?
...
There is currently a HIP being worked on to fix this issue by getting the hotspots that missed the airdrop due to this error their IOT.
