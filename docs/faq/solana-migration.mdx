...
## Why didn't my hotspot get the IOT airdrop even though it fell under the active category as defined in [this Helium Doc](https://docs.helium.com/solana/migration/hotspot-operator/#what-is-an-active-hotspot)?
