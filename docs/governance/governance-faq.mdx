...
If you lock up your HNT for veHNT, your HNT will appear as veHNT and remain entirely in your wallet's
...
The veHNT decay countdown starts when initiated from the Wallet app/Modular Governance, either 
