...
deployers, network users, wireless network operators, hardware manufacturers, and more. HNT must
...
specific token. To vote, an HNT owner must first lock their tokens for a period of time, up
