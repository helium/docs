...
Since the implementation of [HIP-141](https://github.com/helium/HIP/blob/main/0141-single-token-governance-and-release-proposals.md#votes-with-code) the governance process has changed. In the future the Helium Community 
...
All changes under this process must come with audited and deployable code. Each Release Vote will be inititalised 
...
deployed on an ad-hoc basis, but must be announced and ratified through subsequent Release Votes.
...
2. **GitHub Repository**: The [HRP GitHub](https://github.com/helium/helium-release-proposals) repository and previous [HIP GitHub](https://github.com/helium/HIP) repository provides access
