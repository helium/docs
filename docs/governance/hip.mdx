...
4. **Pull Request Submission:** The Author forks the Helium GitHub repository, adds the HIP file
   ...
   see step-by-step guide to using Github [here]().
...
5. **HIP Review:** A HIP Editor reviews the submitted pull request. They check for adherence to the
   ...
   - HIP Editor adds edits and comments for clarity, consistency, grammar, punctuation, formatting
     and viability.
   - HIP Editor submits edits to Author for revision.
   - HIP Editor requests changes.
   - At the same time, the HIP Editor begins a conversation with the HIP Author on Discord or Github
     to make sure they are available for questions and engage the Author if more clarity or revision
     is needed.
...
6. **Discussion and Approval:** The HIP enters the discussion phase, during which comments and
   ...
   - HIP Editors have finished merging the file into the main Repo and move on to opening
     discussion.
   ...
   - HIP Editors or Community Managers make an announcement letting the community know the HIP is
     live and open for discussion.
   ...
   - If rough consensus is achieved, HIP Editors inform Helium Core Devs of a proposal that requires
     voting in Realms.
   - HIP Editors prepare the vote, including proposal descriptions, announcements to the community,
     and informing the Author.
