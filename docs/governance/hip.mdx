...
Helium Improvment Proposals (HIPs) are the core unit of change in the Helium Network and for the Helium Community.
...
All HIPs that have passed and been implemented in the Helium Community are listed below. Not all HIPs pass super-majority voting, so you will see some changes in HIP numbers as you go down this list.
Just like bills that become law, HIPs often amend each other. To get a full understanding of how HIPs have been implemented and how each impacts another, join the Discord. Long-time Community Members are a wealth of knowledge and can help folks understand changes over time.

Note: the current status of HIPs 'In Discussion', 'Closed', or that are being acitvly deployed can be found at www.github.com/helium/hip
