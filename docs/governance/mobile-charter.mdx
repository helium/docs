...
Mission: The goal of the Mobile PoC Working Group is to work collaboratively on the HIPs that
improve and advance the Proof-of-Coverage framework used by the MOBILE subDAO to ultimately drive
incentives for creating useful coverage.
