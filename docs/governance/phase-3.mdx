...
Realms was the previous phase of Helium Governance. Realms is a Solana native tool for
...
You can view past proposals on Realms by navigating to either the Helium Network or subnetworks at:
...
** This is adetailed step-by-step description of how voting using realms was actioned at the time of
the Helium migrtaion. All steps that required the signing of a transaction are noted as such:**
