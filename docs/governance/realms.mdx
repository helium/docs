...
You can learn more about Staking on Realms [here.][staking]
...
first time, check out [this onboarding and swap tool][swap-utility].
...
The majority of HIP discussion happens on the [Helium Discord][discord]. Many HIPs get their start
in the #hip-discussion channel. Additionally, each HIP under consideration gets its own channel for
focused discussion.
...
[staking]: /vote-escrow/realms
[swap-utility]: /helium-tokens/sol-token#swap-utility
