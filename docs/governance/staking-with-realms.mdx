...
This guide outlines using Realms with the [Helium Wallet App](/helium-wallet-app). To use Realms on
a desktop browser, a Solana-compatible browser wallet can be used (such as Phantom or Backpack).
