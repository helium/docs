...
veTokens can be managed through [Helium Vote](/governance/staking-with-Helium-Vote) using the in-app browser
on the [Helium Wallet App](/wallets/helium-wallet-app):

- [HNT DAO on Helium Vote](https://heliumvote.com/hnt)
- [IOT subDAO on Helium Vote](https://heliumvote.com/iot)
- [MOBILE subDAO on Helium Vote](https://heliumvote.com/mobile)
