...
Today, the Helium Network utilizes the tool Realms for on-chain voting. Since the passage of HIP 51-
...
The [Helium Network][realms-helium] and the Helium Network serve as the overarching system that
enables a multitude of networks (subNetworks) to exist. As such, veHNT's role in network governance
is in matters affecting the entire network. For example, a proposal affecting HNT emissions would be
voted on using veHNT.
...
The [IOT subNetwork][realms-iot] focuses on the original vision of the Helium Network, supporting
...
[realms]: https://www.realms.today
[realms-helium]: https://realms.heliumvote.com/dao/hnt
[realms-iot]: https://realms.heliumvote.com/dao/iot
[realms-mobile]: https://realms.heliumvote.com/dao/mobile
[delegate]: /staking-with-realms#delegating-stakes
