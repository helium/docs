...
| Year    | HNT at start of year | Target HNT Emission |
| :------ | :------------------- | :------------------ |
| 1       | 0                    | 60,000,000          |
...
**\*** Helium migrated to the Solana blockchain in year 4 of the network. Full token emissions can
be viewed in the HNT section of this document:  
...
reported by the [HNT Price Oracles](/blockchain/oracles). Let's look at a few examples of how this
works on-chain.
