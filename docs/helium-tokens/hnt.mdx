...
The full token emission schedule can be viewed in the HNT section of the [Token Emissions as of
Solana Migration][sol-emissions] document.
...
and intends to allow for the supply of HNT to respond to Network usage trends such that the amount
of HNT that exists remains static month on month. The amount of DC produced by burning HNT will
increase and decrease based on the USD price of HNT as reported by the HNT [Price
...
[datacredit]: /helium-tokens/data-credit
...
[iot]: /helium-tokens/iot
[mobile]: /helium-tokens/mobile
...
[txn-fees]: /blockchain/transaction-fees
