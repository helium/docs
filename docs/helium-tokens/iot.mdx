...
The emission schedule was created in [HIP-52](hip-52-emmisions) and confirmed in
[HIP-77][hip-77-emmisions] and is as follows:
...
> Full token emissions can be viewed in the IOT section of the
> [Token Emissions as of Solana Migration](migration-emissions) document.
...
[hip-52-emmisions]: https://github.com/helium/HIP/blob/main/0052-iot-dao.md#emissions-curve
