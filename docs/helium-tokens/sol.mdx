...
Open this page from within the browser of the Helium Wallet App (Click on Globe icon) to add the SOL to 
your  wallet app. 
...
transfers). You may need to acquire more SOL to enable HNT lockup. We recommend having more than the minimum amount of SOL in case you need to fund additional accounts in the
future.
