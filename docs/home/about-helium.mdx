...
The underlying blockchain infrastructure that provides security, scalability,
and decentralization for the Helium Network.

**HNT Token:** 

The native token of the Helium Network, serving as an incentive mechanism for network participants
and facilitating seamless transactions within the ecosystem

**IOT Token:**

A specialized token dedicated to the LoRaWAN network, empowering low-power, wide-area network connectivity for Internet of Things (IoT) devices.
The Proof-of-Coverage (PoC) consensus mechanism is employed for the LoRaWAN subnetwork, ensuring reliable service.

**MOBILE Token:** 

A designated token for the 5G network, enabling high-speed mobile connectivity and efficient data transmission.
The Proof-of-Coverage (PoC) consensus mechanism is also implemented for the 5G subnetwork, ensuring optimal performance and reliability.
