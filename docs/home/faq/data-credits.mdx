...
Data Credits for Hotspot owners are created on-demand through the implicit burn mechanism and used
to pay all Hotspot transaction fees such as adding Hotspots, sending HNT, and asserting location.
These Data Credits are burned automatically from the available HNT in your wallet or by the CLI.
