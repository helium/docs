...
wireless technologies, such as LoRaWAN and 5G. These subnetworks employed their native tokens, IOT and
MOBILE, and used the unique Proof-of-Coverage consensus algorithm to reward participants for network
coverage.

## Present and Future

Today, the Helium Network is a rapidly growing decentralized wireless infrastructure network with a global
