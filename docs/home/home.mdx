  ...
  <div class="row">
    ...
    <div class="col col--12">
      <p>
        ...
        produce and are compensated in IOT, the native cryptocurrency of the Helium IoT Network, now
        on the Solana blockchain. The Helium Network is a new, open-source, public network created entirely to incentivize
        the creation of physical, decentralized wireless networks. Today, the Helium IoT Network,
        and its <a href="https://explorer.helium.com/">hundreds of thousands of Hotspots</a>, deployed
        by a global community, provide access to the largest decentralized LoRaWAN&trade; Network in the world.
      </p>
      <p>
  ...
  <div class="row">
    <div class="col col--6" style={{ marginBottom: 100 }}>
      ...
      <a className="block" href="/archive/blockchain/mining">
        <img className="docicon" src={useBaseUrl('img/icons/docicon.svg')} /> Earning IOT
      </a>
    ...
    <div class="col col--6 blockgreen" style={{ marginBottom: 100 }}>
      ...
      <h3>Use the Helium IoT Network</h3>
      <p className="podtext">
