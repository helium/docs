  ...
  <div class="row">
    ...
    <div class="col col--12">
      <p>
        ...
        incentivization. It leverages the Solana blockchain for its foundation. The primary token
        powering the network is HNT, while IOT and MOBILE tokens are used to facilitate the LoRaWAN
        and 5G subnetworks, respectively. Proof-of-Coverage is a unique consensus algorithm employed
        by the subnetworks. Today, the Helium Ecosystem, and its{' '}
        <a href="https://explorer.helium.com/">hundreds of thousands of Hotspots</a>, deployed by a
        global community, provide access to the largest decentralized wireless network in the world.
      </p>
      <p>
