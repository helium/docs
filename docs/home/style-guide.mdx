...
This page serves as an example when styling Markdown-based Docusaurus sites.
...
Images from any folder can be used by providing a path to the file. The path should be relative to
the Markdown file.
