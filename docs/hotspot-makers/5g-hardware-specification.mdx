...
Hotspots provide sensor devices access to the Helium network via radio. In addition, some Hotspots
also participate in the Helium blockchain and earn Proof-of-Coverage (PoC) rewards. The degree of
participation depends on the Hotspot’s processing power and storage.
...
- RAM **decreases**
- Storage **decreases**
- Change in **radio or radio location. \*\***No re-audit is required if one SX130x PCIe card with
  the same chipset is swapped for another, such as SX1302 for SX1303.\*
