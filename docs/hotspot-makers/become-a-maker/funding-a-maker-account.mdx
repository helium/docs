...
Data Credits cannot be refunded, exchanged for other tokens, or transferred between wallets. Operations should be first tested with a small test amount. Always double-check the addresses before performing essential operations.
