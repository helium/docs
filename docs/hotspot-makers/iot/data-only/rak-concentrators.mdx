...
slug: /hotspot-makers/iot/data-only/rak-concentrators
---
...
[Light Hotspots - BETA](/hotspot-makers/iot/light-hotspots) and the
...
information about that process [here](/hotspot-makers/iot/data-only-hotspots#pre-requisites).
