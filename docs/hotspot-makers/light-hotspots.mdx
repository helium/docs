...
Approved Hotspots to Light Hotspots as a software upgrade; updated with HIP70 in mind.

The conclusion of the Light Hotspot project is in progress. **Last updated Friday April 20,
2023**.
...
## What is a Light Hotspot? [Now updated April 20, 2023]
...
The core team has completed work on these Oracles. Roughly speaking, a Hotspot will Beacon on its own,
...
- **xxx**: HIP-70 passed and Light Hotspots are completed
