...
**Data packets** carry payload from your device to your systems.

**Network management** packets are sent by the LoRaWAN Network Server in the course of managing your device’s
connection to the network. This may add anywhere from  
...
| Upfront or Yearly Costs  | Description                    | Data Credits | Dollars |
|:-----------------------:|:-------------------------------|:-------------|:--------|
...
|Yearly                   |Running and managing a Router (Optional)  | 0            | $12,000+ (varies)|
|-----------------|-----------------|-----------------|----------------|
|Total Upfront            |OUI + DevAddr + Device registration| 11,000,000|$1,100|
|Total Yearly (without Router)|Packets plus billing reconciliation| 11,440,000|$114.40|
|Total Yearly to run own Router| Own Router               | 0| $12,000+ (varies)|