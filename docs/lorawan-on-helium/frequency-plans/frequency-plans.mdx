...
Where a frequency plan is "Unknown" it means that non of the above Frequency Plans has been known to
...
#foundation in the Helium Community Discord, to help initiate the LoRaWAN Alliance define a
