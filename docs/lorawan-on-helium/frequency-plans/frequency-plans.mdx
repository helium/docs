...
you confirm the appropriate frequencies for gateway configuration each country.
...
LoRa gateways on the Helium Network need to transmit on uplink frequencies! This
may require special configuration at times as some gateways have their transmit
frequencies limited to only downlink frequencies.
