...
Where a frequency plan is "Unknown" it means that non of the above Frequency Plans has been known to be assigned by the local telecommnications or radio authority in that country for use by LoRaWAN. People in those countries are enouraged to contact the Helium Foundation LoRaWAN Committee via #foundation in the Helium Community Discord, to help initiate the LoRaWAN Alliance define a frequency plan for use in your country.
