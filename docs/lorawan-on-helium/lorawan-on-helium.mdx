...
The LoRaWAN Network on Helium is **compatible with LoRaWAN class A devices**. However, Helium
distinguishes itself in how it treats the LoRaWAN Network Server (LNS).
