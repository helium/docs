...
As of 2023, Helium will be utilizing an Open LNS Initiative to allow more choice and increase usability.
You can read more about the Open LNS Initiative at the [Helium Foundation Blog]https://medium.com/helium-foundation/scaling-iot-growth-with-heliums-open-lns-initiative-c906e6953d6d) or read more [here] (insert docs link).
