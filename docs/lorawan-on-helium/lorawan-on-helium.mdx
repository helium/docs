...
The LoRaWAN Network on Helium is currently **compatible with LoRaWAN class A devices**. 
However, class C support is coming in 2023 Q1 and Helium distinguishes itself in how it 
treats the LoRaWAN Network Server (LNS).
