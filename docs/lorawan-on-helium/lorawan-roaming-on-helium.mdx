...
pagination_label: LoRaWAN Roaming On Helium
...
other public and private LoRaWAN Network Server providers (LNSs) who want to extend their coverage
...
major LNSs are roaming with the Helium Network, which means the public coverage the community is
...
- [Helium Network Data Credits](/use-the-network/console/data-credits/) - The financial mechanism
  for purchasing packets from the Helium Network
