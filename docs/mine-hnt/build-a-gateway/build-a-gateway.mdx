...
Before proceeding, you want to make sure that [you have a Miner running](mine-hnt/run-a-miner). If the Miner is running on the Raspberry Pi already and is properly mapped to port 1680, then there's nothing to do! Otherwise, read on.
