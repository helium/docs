...
slug: /mine-hnt/build-a-packet-forwarder
---
...
The ability to mine HNT with anything other than [Approved Hotspots](https://helium.com/mine) is 
not yet supported. Please join the Helium Discord Server and the #hotspot-diy-hardware channel for
...
The `#hotspot-diy-hardware` channel in the [Helium Discord](https://discord.gg/helium) is a great community resource 
for real-tume help when deploying a Helium Packet Forwarder. 
...
<img
  src={useBaseUrl("img/mine-hnt/run-a-miner-security-group.png")}
/>
...
[using a miner section](/mine-hnt/build-a-packet-forwarder/#using-the-miner). Docker's
...
the [using a miner section](/mine-hnt/build-a-packet-forwarder/#using-the-miner)). Or
