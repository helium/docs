...
When you buy [an approved hotspot](https://www.helium.com/mine), you are
...
'system mount point\`, i.e. a directory in your host system; some long-term miner
data is stored there. This allows you to easily maintain your miner's blockchain
identity \(i.e. swarm keys\) and blockchain state through miner image updates.
...
The `--publish 1680:1680/udp` binds your system port 1680 to the container's port
...
blockchain. You generally want to be careful who you accept snapshots from as they
...
of the blockchain is a nice convention. Also, when using a Docker container, it's usually
...
You want to change the field "server_address" from "localhost" to the IP
