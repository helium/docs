...
Legitimacy categorizes the Trust Score based on the following ranges:

<div className="img-center">
  <img className="appscreenbanner" src={useBaseUrl('img/crowdspot/trust-score-bar.png')} />
</div>

| Range Lower | Range Upper |               Legitimacy Label                |
| :---------: | :---------: | :-------------------------------------------: |
|     90%     |    100%     |                  Legitimate                   |
|     70%     |     90%     |               Likely Legitimate               |
|     30%     |     70%     | Inconclusive (further evaluation is required) |
|     0%      |     30%     |              Unlikely Legitimate              |
