...
**[#gateway-development](discord://discord.com/channels/404106811252408320/784462269072277576)** channel on the
...
also called localhost) and port 1680 is the port the helium service is communicating on.
**Don't** use the value assigned by your router or the public IP address.
