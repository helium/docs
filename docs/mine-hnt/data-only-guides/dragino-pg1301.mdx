...
only for Device Packet Transfer.

Remember to keep an eye on [Light Hotspots - BETA](/mine-hnt/light-hotspots) and the
...
:::warning If you lose this key, you will not be able to use this hotspot anymore in case there is a
problem on your hostpot (SD card corrupted, etc). You will need to generate a new key and lose your
existing animal name/hostpot configuration :::
