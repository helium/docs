...
currently supported. Please join the [#gateway-development](https://discord.gg/helium) channel in
the Helium Discord Server for the latest updates.
...
[Light Hotspots](/mine-hnt/light-hotspots) for more information. This process will require using the
Helium [command-line interface (CLI) Wallet](https://github.com/helium/helium-wallet-rs) to submit
the onboarding and assert location transactions.
