...
As part of the Light Hotspot project, a new class of Hotspots called "Data-Only Hotspots" can be added to the blockchain, meaning Dragino LPS80/DLOS8 Hotspots can be added to the Network. These Hotspots can mine HNT for transferring data but never for Proof-of-Coverage. See
[Light Hotspots](/mine-hnt/light-hotspots) for
