...
[Light Hotspots - BETA](/mine-hnt/light-hotspots) and the **#gateway-development** channel on the
[Helium Discord Server](https://discord.gg/helium) to check how the development process evolves.
