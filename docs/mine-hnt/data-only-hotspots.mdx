...
:::info
Note:  These fees are not the same thing as Data Credits, and purchasing Data Credits in Console is not a method of paying this fee.  Instead, this fee needs to be paid by transferring funds from a wallet such as Binance or similar.
:::
...
The `DATA_ONLY_HOTSPOT_PUBKEY` in the example from the previous section
