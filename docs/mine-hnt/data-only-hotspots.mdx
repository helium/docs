...
Data Credits in your Helium Console organization cannot be used to pay
...
At this point, you will want to be certain that you've backed up the data only
hotspot's keypair. Its location can be customized in the client's
