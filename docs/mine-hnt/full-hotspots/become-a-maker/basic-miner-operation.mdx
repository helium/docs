...
slug: /mine-hnt/full-hotspots/become-a-maker/basic-miner-operation
---
...
steps outlined [here](/mine-hnt/full-hotspots/become-a-maker/docker-integration), where you will
learn how to integrate it with security modules and BLE.
...
[using a miner section](/mine-hnt/build-a-packet-forwarder/#using-the-miner). Docker's `exec`
...
[using a miner section](/mine-hnt/build-a-packet-forwarder/#using-the-miner)). Or create an alias
such as: `alias miner="docker exec miner miner"`
