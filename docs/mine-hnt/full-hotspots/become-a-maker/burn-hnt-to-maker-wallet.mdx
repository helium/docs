...
During the course of your testing, you can use the Maker Integration Test wallet address created by the Helium Foundation.  This wallet does not contain any Data Credits so onboarding transactions will fail but it allows you to smoke test the onboarding steps. Here is that address:
