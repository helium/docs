...
## Helium Hotspot Wallet App Compatibility
...
In this codebase, you’ll want to modify the onboarding flow to add a UI element that enables users to select your Hotspot type on this screen:
...
* Setup instructions in [src/locales/en.ts](https://github.com/helium/hotspot-app/blob/main/src/locales/en.ts)
...
All Maker Accounts are public on the blockchain [and can be found here](https://helium-onboarding-server.herokuapp.com/api/v2/makers). 
