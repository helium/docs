...
is was made clear that open and easy access to the `swarm_key` is not permitted
...
And finally, you will want to extra the `onboarding_key` which is also called
