...
Approved Hotspots to Light Hotspots as a software upgrade; updated with HIP70 in mind, should it pass. 
...
Before the introduction of [HIP 70](https://github.com/helium/HIP/blob/main/0070-scaling-helium.md), the goal was to move Challenge creation and Consensus work to Validators. Since HIP-70 and the introduction of Off-Chain PoC oracles, the definition of Light Hotspot and what it will do has changed. Please read on for detailed changes and timelines.
...
move the blockchain off the Hotspots and Proof-of-Coverage receipts to an Oracle. At the conclusion of
Light Hotspot development, the entire Helium blockchain will be removed from Hotspots, Hotspots will Beacon on their own without external input, and all data transfer and Proof-of-Coverage receipts will go to Off-Chain Oracles. 
...
1. The launch of the IOT Subnetwork as described in [HIP-52](https://github.com/helium/HIP/blob/main/0052-iot-dao.md)
