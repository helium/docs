...
A conversion of a Full Hotspot running Light Hotspot software is now being tested on [Testnet](testnet-explorer.helium.com).
...
You can see their progress on [Testnet](testnet-explorer.helium.com).
