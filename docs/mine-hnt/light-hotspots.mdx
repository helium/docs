...
This project is in progress and subject to change. **Last updated Monday April 4, 2022**.
...
- **April 6 2022**: Code related to Light Hotspot merged to production, in an inactive state. Light Hotspot software update tagged for Makers to upgrade their fleet. Validators will also receive a mandatory software update.
- **April 19 2022**: Activate set of chain variables to enable Light Hotspots on Mainnet
