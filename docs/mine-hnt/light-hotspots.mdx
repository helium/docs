...
Work for both Milestone 3 and 4 are under way. The core team is focused on getting Full Hotspots -> Light Hotspots first due to the increasing size of the network and the amount of work needed to sustain this large peer-to-peer network.
