...
Hotspots, please join the [#gateway-development](discord://discord.com/channels/404106811252408320/784462269072277576) channel on
...
#### What's on Testnet?
Software-based miners are receiving block information and challenges from validators. These software-based miners are participating in Proof-of-Coverage. See them in action on testnet-explorer.helium.com

Next: 
- Run Light Hotspot software on Hotspot Hardware (Helium Hotspots and other Maker Hotspots) on testnet


#### What's on mainnet?
2 testing Hotspots will receive an update on Mainnet that routes non-PoC packets using the Light Hotspot code. 
