...
At this phase, Light Hotspots will be onboarded using the [Helium Wallet CLI](https://github.com/helium/helium-wallet-rs), and **will not earn any HNT**. Upgrading these Light Hotspots to allow them to participate in Proof of Coverage will not be possible.
