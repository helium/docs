...
Data Only Hotspots are added to the blockchain by paying a $5 Add Gateway transaction fee, and a $10 Assert location transaction fee using the [Helium Wallet CLI](https://github.com/helium/helium-wallet-rs) and will not earn $HNT.
