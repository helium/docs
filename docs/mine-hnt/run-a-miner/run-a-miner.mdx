...
[using a miner section](/docs/mine-hnt/run-a-miner#using-the-miner). Docker's
...
the [using a miner section](/docs/mine-hnt/run-a-miner#using-the-miner)). Or
...
[build a gateway](/docs/mine-hnt/build-a-gateway) section.
