...
Visit the [Helium Validator Status Page](http://validators-status.helium.com/) (and sign up for alerts, if you haven't already). This status page will provide the latest updates on important issues that impact validators (chain halts or other major events).
