...
Running a Validator on Mainnet requires a stake of `10000 HNT` per Validator. After you've created your wallet, transfer a little more than `10000 HNT` into it for each Validator you intend to run. (The extra will cover the transaction costs required for the staking and unstaking operations. An additional `2` HNT per Validator will be more than enough to cover this.) 
