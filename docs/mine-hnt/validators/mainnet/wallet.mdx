...
The number 1537797 shown below is only an example. You must look up the current [block height in 
explorer](https://explorer.helium.com/blocks) and use the current block height in your calculation
of the `stake-release-height`.
...
`stake-release-height` = `1537797 (current block height) + 125000 (cool down period) + 30 (grace
period)` = `1662827`. 
