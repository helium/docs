...
- Internet Connectivity:
  ...
  - Firewall running on the validator host OS or commercial grade firewall capable of handling thousands of concurrent connections 
  - These guidelines are intended to mitigate penalties caused by dropped network connections during while in the consense group
- Operating system: 
