...
As the role of  validator continually grows, it may require more resources over time. Once you have built your validator, you can refer to some of the steps shown at [Troubleshooting](https://docs.helium.com/mine-hnt/validators/troubleshooting/) to check its performance.
...
- Internet Connectivity:
  - Commercial grade Internet connectivity with redundancy such as BGP. Not home fiber or cable modem Internet.
  - Static WAN IP address
  - Firewall running on validator host OS rather than validator behind a separate firewall
- Operating system: 
...
- CPU: 
  - Intel, AMD or ARM based processor 3.0 GHz or above with 4 cores or equivalent, such as AMD Ryzen Zen3 CPU (5950X being the top choice) and Intel i9-1200k.
