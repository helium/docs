...
- If using AWS, a t2.xlarge or c5a.xlarge EC2 instance or equivalent is recommended. If using another cloud provider, like GCP, Azure, [Akash](https://docs.akash.network/tutorials/helium-validator) or Digital Ocean, an instance with similar capabilities should be the target.
