...
- Storage: 256 GB or more for mainnet.  64GB is sufficient for testnet. This should not be on the OS disk and remoting your `/home/*` directory on a seperate disk is recommended.
...
- Overall Baselining (do this after the validator is caught up to the tip of the chain, and running normally for a few hours)
  ...
  - If you believe you are having trouble getting the advirtised disk performance you can install and run the `fio` package to give you a full baseline of disk performance.
