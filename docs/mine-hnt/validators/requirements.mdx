...
[performance penalties](/mine-hnt/validators/penalties/). Minimizing your penalties increases your
chances of being elected to the Consensus Group and earning more rewards.
...
[SHOULD NOT BE RUN ON A HOME NETWORK](/mine-hnt/validators/faqs-resources-providers/#technical). The
one exception to this is if you live at an actual data center. If that's the case, you're allowed to
run Validators at home.
...
- You can also refer to some steps shown at [Troubleshooting](/mine-hnt/validators/troubleshooting/)
