...
See details for why Validators [SHOULD NOT BE RUN ON A HOME NETWORK](/mine-hnt/validators/faqs-resources-providers/#technical). The one exception to this is if you live at an actual data center. If that's the case, you're allowed to run Validators at home.
