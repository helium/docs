...
the [Testnet Explorer](https://explorer.helium.wtf) are scheduled and have intervals. Basically, you won't
...
Head over to the [Helium Testnet Explorer's Validators Page](https://explorer.helium.wtf/validators)
...
- Your validator block height (`miner info height`) is higher than the block height reported on
  [explorer](https://explorer.helium.wtf)
