...
This guide will cover the end-to-end process of deploying a Helium Validator on the Testnet. It assumes
you're starting from scratch. At the end, you'll have a Helium Validator deployed on the Test Network.
...
And checkout the latest Testnet Validator tag. Consult GitHub https://github.com/helium/miner/tags for the current version and replace it into
this command:
...
the [Testnet Explorer](https://testnet-explorer.helium.com/) are scheduled and have intervals. Basically, you won't
...
The result of `docker exec validator miner info p2p_status` command can look like:
...
- find address of the Validator elected into the Consensus Group on the [Testnet Explorer](https://testnet-explorer.helium.com/validators/consensus)
...
Head over to the [Helium Testnet Explorer's Validators Page](https://testnet-explorer.helium.com/validators)
