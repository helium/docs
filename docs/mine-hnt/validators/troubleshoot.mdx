...
There is a #validator [Discord](https://discord.gg/helium)  channel available to reach other testnet participants. Also use this channel to share feeback and report issues discovered while testing.
...
## Compromised server
If you find that the server has been compromised, just wipe it (maybe saving the blocks somewhere), close the hole, stand up a new validator and then transfer the stake to it.
