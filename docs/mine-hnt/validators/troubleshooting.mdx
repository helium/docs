...
[here](/mine-hnt/validators/mainnet/deployment-guide/#:~:text=a%20timely%20manner.-,Upgrade%20your%20Docker%20container,-To%20do%20manual)
...
- Consider migrating to the debian validator package from the
  [Mainnet Deployment Guide](/mine-hnt/validators/mainnet/deployment-guide/#:~:text=Deploy%20the%20Validator%20from%20deb%20package)
...
[Validator Penalties and Impact on Rewards](/mine-hnt/validators/penalties/).
...
[Baselining Your Validator](/mine-hnt/validators/requirements).
