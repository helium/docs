...
There is a `#validator` [Discord](https://discord.gg/helium) channel available to reach other
validator participants. Also use this channel to share feedback and report issues.
