...
### Check the API
https://testnet-api.helium.wtf/v1/validators/ or https://testnet-api.helium.wtf/v1/validators/<validator_address>
...
You may need to adjust these if you're running in docker.
