...
It enters an unbonding state for approximately 3 months (125,000 blocks) and cannot be restaked. During this state the **validator does NOT earn rewards and the staked amount cannot be transferred or withdrawn**. After the unbonding state has passed, the stake is returned to the original owner’s wallet.
