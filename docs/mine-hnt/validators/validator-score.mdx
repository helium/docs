...
Validator nodes earn rewards for work performed while in the consensus group.

Validator nodes start with a base score 1.0. The network uses the score to choose which validator nodes join, and when they are removed from the consensus group.
