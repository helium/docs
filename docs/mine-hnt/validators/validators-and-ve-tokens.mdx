...
In the Helium ecosystem, HNT holders can receive veHNT by locking their HNT on chain from further access for
a specified period in exchange for voting rights and power in the HeliumDAO
([HIP 51](https://github.com/helium/HIP/issues/336)). Additionally, this provides other benefits, such as earning MOBILE or
...
Currently staked validators receive the 6% of HNT allocated to the consensus group and the 0.85% allocated to the Beacon Challengers. Thus staking token rewards is 6.85% of the total HNT emission per epoch/day/month. This is fixed and unchanged until PoC is removed from earnings and the total figure reduces to 6%.
After HIP 51-53 are implemented, all the subDAOs combined will get 68% of emitted HNT and the amount allocated to the vote escrowed tokens is a maximum of 6% of this 68% across all subDAOs. So the new figure is 6% x 68% = 4.08% of the total HNT emission per epoch/day/month.
On 1st Aug 2023 the 68% figure increases by 1% to 69% and the amount issued for veHNT increases proportionally to 4.14%
This 69% further increases by 1% each year on August 1st untill the max of 85% goes to the subDAOs and the amount issued for vote escrowed tokens increases to 5.1% and stays at this value.

### So, If I'm a Validator, I Move From Roughly a Fixed 6% to a Fixed 4% Reward For Staking?

No. The 6% to validators always varied depending on the luck of consensus group membership and the operational ability of the validator owner to maintain a high score and update status to be selected for consensus. Individual validators earned more or less than 6%.

In the future with veHNT staking this 4% is shared to all the subDAOs and unless you perfectly match your veHNT split delegated with the Utility Score split between the subDAOs, you will also earn more or less than this 4%.

If you stake more proportionally in a subDAO than others, and it does better proportionally than the other subDAOs for size/data rewards, your subDAO rewards amount will increase and its value against HNT will increase.
...
If you stake your HNT for veHNT, your HNT will become veHNT and will remain completely in your wallet custody. In exchange for your HNT, veHNT will deposit into your wallet.
...
Anyone can stake ANY amount of HNT for a period of 6 months to 4 years. You choose your unstaking date at the time of lock-up.
...
Anyone can delegate veHNT to a subDAO for token rewards (DAO Utility Score). 
Delegating veHNT to a subDAO allows you to proportionally earn subDAO token rewards.
...
Those that stake HNT for 6 months, will recieve an exchange of 1:1 HNT to veHNT. 
Those that stake veHNT for 48 months will recieve an exchange of 1:100 HNT to veHNT. Any time period in between that will be treated on a linear scale from 1 to 100.

For example: I choose to lock up 10 HNT for 6 months. I recieve 10 veHNT. After 6 months, my veHNT decays to 0 and I recieve my 10 HNT back into my wallet.
...
Only during the 7 day ”genesis” period, after the HIP 70 migration to the Solana blockchain, will new stakers receive 3x the veHNT they would normally receive for staking.

For example:
Staking 10 HNT for 6 months gets 30 veHNT (10x1x3) that decays from 30 to 0 veHNT at the end of the staking period and 10 HNT is returned to the wallet.

Staking 20 HNT for 24 months gets around 2598 veHNT (20x43.3x3) and these decay to 60 veHNT at 6 months and then remain at 60 veHNT that decays to 0 veHNT at the end of the last month of the staking period and 20 HNT is returned to the wallet.

### Will I Earn HNT by Staking For veHNT?

No. HNT stakers will not actually earn anymore HNT than they stake.

HNT staked to veHNT will not earn more HNT at the end of the staking period. When you stake 1 HNT to 1 veHNT for your set lock-up period, you will recieve the same amount of HNT back, at the end of the lock-up period.

However, when you stake HNT into veHNT you are allowed to delegate your veHNT into one or more subDAOs (such as IOT and/or MOBILE) and the subDAOs allocate up to 6% of their token emissions to the veHNT owners delegating to that subDAO.

For example: When you delegate your veHNT to the IOT subDAO, you recieve IOT every epoch directly into your Helium Wallet.
This IOT can then be burned at the IOT subDAO treasury for HNT at the floor level of the IOT/HNT treasury exchange rate and deposited into your Helium Wallet.

### How Do I Stake for veHNT After HIP 51 and 70 Are Implemented?

1. To stake, transfer HNT into your Helium Wallet App (black icon app). Perform this step if you do not already have HNT in your wallet.
2. Using the Helium Wallet App, stake HNT into veHNT, and define the period of lock-up. The granularity of selection will likely be in blocks.
3. Using the Helium Wallet App, delegate that veHNT into one or more existing subDAOs. You may have to complete several transactions depending on how many subDAOs you are delegating to.
...
This process should be farily simple in the black wallet app. More instructions will be provided as we get closer to the Solana migration.

All staking and vote escrow delegation operations will be performed within a Solana compatible Wallet App or the Helium wallet CLI. The black Helium Wallet app will be Solana compatible.
...
The decay in the veHNT quantity in a wallet is granulated per epoch, and the veHNT delegated to a subDAo decays at the same rate.

A 48 month lock-in period has approximately 42 (48-6 months) x 30 (days) x 48 epochs (30 mins) = 60,480 linear steps between 100 veHNT and 1 veHNT. 

After 1 epoch has passed after staking a single 1 HNT for 48 months the quantity of veHNT in the wallet will decay from 100 veHNT to 99.998347 veHNT.  This will decrease by this very small amount every 30 mins over the 42 months till it reaches 1 veHNT and remains at 1 veHNT for 6 months.

A table showing the approximate HNT to veHNT multiplier for each month of starting a stake or veHNT a stake has decayed to. Delegating veHNT to a subDAO or veDNT staking decays at the same rates.
...
Yes. You can increase your staking period to the maxium of 48 months at any time. It will be activated at the next epoch.
...
This is being evaluated as the future default option for staking. This will not be available on day 1 on the Solana migration.

### Can I Transfer my veHNT or Any of The veDNTs, like veIOT or veMOBILE, to Someone Else?

No. veHNT and the like is fully non-transferable, and represents your voting power in the network. It is not a token.

### How Do I Buy veHNT or Any of the veDNTs, Like veIOT or veMOBILE?

You cannot buy veHNT or any of the other veDNTs. It is not a token. veHNT can only be obtained by staking HNT with a lock-up period.
Likewise, you cannot buy veIOT or veMOBILE.
veHNT and veDNT have no price in the larger crypto markets.

### What Is the DAO Utility Score?

The Utility score is described in ([HIP 51](https://github.com/helium/HIP/issues/336)). Each new sub-token of HNT, which are MOBILE and IOT (so far), have a utility score which mathematically describes the proportion shared of HNT tokens distributed to them every epoch from the fixed amount allocated to all subDAOs. 
The higher the utility score, the bigger the proportion of HNT emitted to that subDAO’s treasury per epoch.
A sub-token with a utility score of 100 would receive ⅔ of the emitted HNT in an epoch, assuming the other token had a score of less than 100. But would receive ⅓ if the other token had a score of 200
...
1. The amount of data usage on the subDAO, i.e. the Data Credits burned. This increases the 'D' value in the score.
2. The Data Credits used to onboard the number of hotspots for that subDAO. This increases the 'A' value in the score.
