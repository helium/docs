...
stakes to those subDAOs, respectively. After the lock-up period ends, the same amount of HNT is
released back to the owner's wallet and is now transferable, if needed.
...
Anyone can delegate veHNT to a subDAO, it sone component of a subDAO's Utility Score. Delegating
