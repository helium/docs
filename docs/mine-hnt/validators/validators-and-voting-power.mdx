...
For the first ten days after Helium's migration onto Solana, there will be a 3x multiplier bonus
for new veHNT stakers. This is called the "Landrush" multiplier.

New stakers are only eligible to receive this veHNT bonus during the initial ten-day Landrush
...
Validator owners can also take advantage of the 10 day bonus period and get the 3x bonus reapplied if
they extend their default 6 month lock-up period. This 3x bonus will not apply to the later extended
period if they extend the lock-up further after the initial ten days, or veHNT is transfered to
another staking position after the 10 day period.
