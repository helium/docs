...
the passing of HIP-70 and transitioning L1 is that the role Validators play as we know it today will
no longer be required, and Validators will be sunset by the end of Q1 2023 after the transition is
complete.
...
:::info Utitily Score impacts HNT Proportion for a subDAO
...
and 48 months selectable in days but with block granularity. The minimum lock-up period is subject
to change between now and the migration date.
...
four years. You choose your unstaking date at the time of lock-up or deciding to keep it on a
...
:::info Lock-up exchange rates subject to change

Proposals are in review and subject to vote to change the linear scale from 0-100 over 48 months not
1-100 over 42 months.
...
:::info This is not available today.
...
lock-up further after the initial seven days, or veHNT is transfered to another staking position
...
N/A = Not applicable. There is Currently a minium period of 6 months lock-up. This is subject to
change and the table below will be updated.
...
wallet will decay from 100 veHNT to 99.998575 veHNT. This decrease will recur linearly over all the
