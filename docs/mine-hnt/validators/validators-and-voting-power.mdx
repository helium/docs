...
3. Using the Helium Wallet App browser (Globe icon) access /Realms, delegate that veHNT into one or 
   more existing subDAOs. You may have to complete several transactions depending on how many subDAOs 
   you delegate to, or if you want different amounts delegated for different lock-up periods.
...
The Helium Wallet App is Solana compatible. All staking and vote escrow delegation operations
will be performed within the Helium Wallet app browser and Realms
...
You cannot buy veHNT, veIOT or veMOBILE. They are not a tradable tokens. veHNT can only be
obtained by staking HNT with a lock-up period. Likewise, for veIOT or veMOBILE.
...
currently 68% until April 1st 2023. The higher the Utility Score, the more significant the proportion
of this 68% of HNT is emitted to that subDAO's treasury per epoch.
...
Thus it can be observed that delegating more or all of your veHNT to a specific subDAO has 
the opportunity to both increase or decrease your subDAO earnings from delegation.
