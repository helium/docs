...
description:
  Lists available Helium network data APIs, including the official Entity API and third-party
  providers.
...
- Website: [https://heliumgeek.com/api](https://heliumgeek.com/api)
- API Documentation: [https://docs.heliumgeek.com](https://docs.heliumgeek.com)

### Relay

Relay API provides easy access to all Helium Oracle, on-chain, and historical data via simple REST
endpoints. The API is public and free to use with the Community plan, sponsored by the Helium
Foundation. The community can get instant access to data like Hotspot earnings, Hotspot information,
...
Paid plans offer higher monthly API call limits, premium features, and allow fetching all historical
