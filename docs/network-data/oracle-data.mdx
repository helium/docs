...
types comprised within each data category prefix, the file prefixes beginning each filename, the
filename patterns for each of the file types, and links to the corresponding protobuf used to  
decode the data.
