...
description:
  How Helium uses Solana Compression NFTs and concurrent Merkle trees to represent Hotspots
  cost-efficiently on-chain.
image: https://docs.helium.com/img/link-image.png
slug: /network-data/solana/compression-nfts
---
