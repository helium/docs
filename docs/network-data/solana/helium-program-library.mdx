...
description:
  Overview of the Helium Program Library (HPL), the suite of Solana programs and SDKs for building
  on the Helium Network.
image: https://docs.helium.com/img/link-image.png
slug: /network-data/solana/helium-program-library
---
...
To get started with the Helium Program Library (HPL), developers can access the HPL documentation at
[hpl.helium.com](https://hpl.helium.com). The HPL documentation provides detailed guides, tutorials,
and examples to help developers get started with building on the Helium Network.

The HPL GitHub repository can be found at https://github.com/helium/helium-program-library.
