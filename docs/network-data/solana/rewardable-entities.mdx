...
In practice, we have made it so that this can all happen in a singular transaction for reward
claims. Staking rewards will happen in transactions combining up to 4 days of rewards.
