...
[quickstart](/archive/console/quickstart) for instructions on how to add a new device to Console.
...
Next we will create a [_Flow_](/archive/console/flows/orientation). Navigate to the Flows page and
...
[integration](/archive/console/integrations/cargo/#add-a-cargo-integration) and link it to the
