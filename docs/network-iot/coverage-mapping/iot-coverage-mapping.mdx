...
Mapping does not make an Hotspot earn more IOT tokens through Proof-of-Coverage. The real value is
to prove the network, drive adoption, and increase the purchase of Data Credits by commercial users.
