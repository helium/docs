...
unused.) Follow our [quick start guide](/network-iot/console/adding-devices) on how to add a new
device to Console.
...
a decode Function as explained in [our short primer](/network-iot/console/functions). The
