...
In addition, you should setup a [CLI wallet](/cli-wallet) as this is currently the only wallet that
supports DIY Data Only Hotspots. Retail Data Only Hotspots from Hotspot Vendors can be onboarded
using the Vendor IOS and Android apps.
...
["implicit burn" mechanism](/network-iot/transaction-fees/#transaction-fees-and-implicit-burn),
