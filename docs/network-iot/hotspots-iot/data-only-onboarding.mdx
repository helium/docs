...
In addition to the 'miner' classification of Hotspots, the Helium Network additionally enables the
onboarding and operation of hardware to the IoT Network for data transfer. These Data-Only Hotspots
do not earn rewards for Proof of Coverage. This guide walks through the process of setting up and
onboarding a Data-Only Hotspot ("Hotspot") to the Helium Network. By the end of this guide, you will
have:
...
- For example, a company that has deployed a bunch of their own gateways as a private network, but
  now are seeing the growing pains and desire to leverage helium as part of that.
- So in front of them, they effectively have two options.

  - One is they can go to the LoRa Alliance and get a NetID so that they can engage with roaming on
    the Helium Network.
...
- Basically, any hardware can be used, as opposed to MCC-certified hardware.
  - don't need an ECC chip TODO: what is an ECC chip, link to maker docs
