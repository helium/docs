...
account has at least 50,000 Data Credits available to complete the add transaction. The
...
Make sure the paying account has at least 50,000 Data Credits available to complete the assert
