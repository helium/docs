...
slug: /network-iot/hotspots-iot/data-only/balena-data-only-hotspot
---
...
Go to the [Helium Explorer](https://explorer-old.helium.com/) and introduce your URL
`https://explorer-old.helium.com/hotspots/<hotspot address>`.
