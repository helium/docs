...
pagination_label: Dragino PG1301 + Raspberry Pi
sidebar_label: Dragino PG1301 + Raspberry Pi
description: Helium Documentation
image: https://docs.helium.com/img/link-image.png
slug: /network-iot/hotspots-iot/data-only/dragino-pg1301
---
...
[here](/network-iot/hotspots-iot/data-only-hotspots#pre-requisites).
