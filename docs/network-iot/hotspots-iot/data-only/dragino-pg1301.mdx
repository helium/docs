...
data from the end devices (LoRaWAN nodes). The Data-Only Hotspots are eligible for Network
...
If you have an end device (LoRaWAN node), you can check if the Data-Only Hotspot can transfer
