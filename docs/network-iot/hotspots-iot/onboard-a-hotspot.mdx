...
gain (in dBi). A Hotspot must be onboarded before its location can be asserted.
...
For the step-by-step guide, see [On-Device Onboarding](/iot/onboard-a-hotspot/on-device).
