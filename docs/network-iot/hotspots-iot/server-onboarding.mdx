...
Hotspot must also be onboarded on-chain by adding it to a wallet and asserting its location with the
...
A community demonstration is available at
[heliumtools.org/multi-gateway](https://heliumtools.org/multi-gateway).  
Note: this is not an official Helium website and is intended for demonstration purposes. It is not
intended for production use.

Use this demo deployment to quickly explore an onboarding, test the workflow, and build familiarity
