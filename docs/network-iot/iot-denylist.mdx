...
Hotspots physically located next to each other but asserted far apart from each other will trigger
one or both of them to be denylisted.

Setting the Antenna dBi in the Helium App to a value lower than its actual value can cause the 
Hotspot to transmit at illegal higher powers and also be entered on the denylist.

### I've made changes to my Hotspot, how long before I'm removed from the denylist?

Removal is not immediate, it may take 2-3 weeks if all your location and antenna parameters are
now accurate and no other misuse classifiers are triggered.. Your hotspot can be seen to participate 
in Proof-of-Coverage but will not earn tokens until the new data is validated by other non denied 
Hotspots performing PoC activities. Denylist updates are posted on github in the [Denylist repository.](https://github.com/helium/denylist/pulls?q=is%3Apr+is%3Aclosed)
