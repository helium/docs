...
The current iteration of the denylist is a step toward the long-term evolution of proof of coverage
to dynamically evaluate network coverage. The process is fully detailed in the write-up from the
authors of the classifier, [IoT Denylist Evolution](/devblog/2023/08/07/denylist-evolution).
...
appropriately asserted attributes, further analysis of the Hotspot can take place in the Helium
Community Discord channel,
[#crowdspot-denylist](https://discord.com/channels/404106811252408320/984427647977283674).
...
data-only Hotspot, providing data transfer network coverage where possible. Is it important to
understand the uninterrupted data transfer ability in the case of errant inclusions.
