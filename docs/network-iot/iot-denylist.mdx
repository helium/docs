...
The current iteration of the denylist classifier is a step toward the long-term evolution of proof
of coverage to dynamically evaluate network coverage. The process is fully detailed in the write-up
from the authors of the classifier,
