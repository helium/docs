      ...
      <div class="flex" style={{ border: 'none' }}>
        ...
        <div className="headertext">
          <h2 className="subtitle">
            The Helium IoT Network uses the LoRaWAN&trade; protocol to provide internet connectivity to
            "Internet of Things" (IoT) devices and is the original subnetwork in the Helium Ecosystem.
          </h2>
          <h2 className="subtitle">
  ...
  <div class="row">
    ...
    <div class="col col--6" style={{ marginBottom: 100 }}>
      ...
      <a className="block" href="https://www.helium.com/ecosystem">
        <img className="docicon" src={useBaseUrl('img/icons/docicon.svg')} /> Preconfigured Devices
      </a>
    ...
    <div class="col col--6" style={{ marginBottom: 100 }}>
      ...
      <p className="podtext">
        Check out the coverage in your area, and learn about expanding the range of the Helium
        Network.
      </p>
      ...
      <a className="block" href="/tokens/mine-iot/">
        <img className="docicon" src={useBaseUrl('img/icons/docicon.svg')} /> Earn IOT
      </a>
      <a className="block" href="/iot/hotspots">
        <img className="docicon" src={useBaseUrl('img/icons/docicon.svg')} /> Learn about IoT Network
        Hotspots
      </a>
    </div>
    <div class="col col--6" style={{ marginBottom: 100 }}>
