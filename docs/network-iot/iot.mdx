      ...
      <div class="flex" style={{ border: 'none' }}>
        ...
        <div className="headertext">
          <h2 className="subtitle">
            The Helium IoT Network uses the LoRaWAN protocol to provide internet connectivity
            to "Internet of Things" (IoT) devices and is the original subnetwork in the Helium
            Ecosystem.
          </h2>
          <h2 className="subtitle">
