...
After your OUI and devAddrs are added, you can now manage your OUI through the Config Service. You
...
CLI can be initialized with environment variables, so common variables don't have to be reiterated
...
seeing your own assigned OUI, max_copies, and other environment variables.
