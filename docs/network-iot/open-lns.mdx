...
Helium blockchain. Through [HIP-70](https://github.com/helium/HIP/issues/471), these constraints were removed, allowing for a multitude
...
**Accelerated Device Joins:** <br/> The re-engineered back-end architecture removes the need to store
...
innovative use cases, with new LoRaWAN infrastructure allowing IoT solution providers to utilize whichever
...
end devices. Open LNS allows users to choose a different LNS, such as ChirpStack to address these
limitations.
...
- [Parley Labs][parley-labs] provides Helium products and services and supports growth. Parley Labs
  ...
  Helium Ecosystem, providing pre-provisioned products, demonstrating Class C end device functionality,
