...
description: Programmatically adding devices to ChirpStack using the gRPC API and JavaScript SDK.
...
This guide, outlined in the five-step process below, demonstrates how to add a device to ChirpStack
via the gRPC API.
...
<figure className="screensnippet-wrapper">
  <img
    ...
    src={useBaseUrl('/img/open-lns/chirpstack/chirpstack-013-add-api-key.jpg')}
  />
</figure>
<br />

Next, click the `Add API Key` button in the upper right-hand portion of the screen.

<figure className="screensnippet-wrapper">
  <img
    className="add-shadow add-shadow-margin add-border-radius"
    style={{ width: '100%', maxHeight: 'initial' }}
    src={useBaseUrl('/img/open-lns/chirpstack/chirpstack-014-add-api-key.jpg')}
  />
</figure>
<br />
...
<figure className="screensnippet-wrapper">
  <img
    className="add-shadow add-shadow-margin add-border-radius"
    style={{ width: '100%', maxHeight: 'initial' }}
    src={useBaseUrl('/img/open-lns/chirpstack/chirpstack-015-add-api-key.jpg')}
  />
</figure>
<br />

When complete, take note of the API key, as it will not be provided again once you navigate away
from the page.

## Identify Tenant ID Using the ChirpStack Console

Still using the ChirpStack console, the `Tenant ID` can be found by clicking on `Dashboard` under
the `Tenant` header of the left side panel. The `Tenant ID` will then be found near the top middle
of the tenant dashboard page.

<figure className="screensnippet-wrapper">
  <img
    className="add-shadow add-shadow-margin add-border-radius"
    style={{ width: '100%', maxHeight: 'initial' }}
    src={useBaseUrl('/img/open-lns/chirpstack/chirpstack-016-tenant-id.jpg')}
  />
</figure>
<br />
