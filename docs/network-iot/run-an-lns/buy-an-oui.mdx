...
<TopLedgerEmbed
  title="Top hotspots"
  caption="Top 10 hotspots by data transfers for an organisation"
  client="helium"
  queryId="7396"
  visualizationId="21782"
  apiKey="hfK4lqx3BHbaAOBpvZN8FAITgJIPNhNDlZD2bf8c"
  params={{ 'p_oui name': 'Nova Dev Console' }}
/>
