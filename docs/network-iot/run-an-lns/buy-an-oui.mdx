...
with each of the 4 Netwok Session Keys, and the uplink will be attributed to the device whose
...
In practice, some deployers were able to successfully support 100k+ devices with 32 DevAddrs.
