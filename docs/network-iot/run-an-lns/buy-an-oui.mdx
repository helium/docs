...
Direct purchase of OUIs and devAddrs are not currently available on-chain. Send an email with the
subject line 'Purchasing OUI' to the [Helium Foundation](mailto:hello@helium.foundation) containing
