...
Direct purchase of OUIs and devAddrs are not currently available on-chain. Send an email to the
[Helium Foundation](mailto:hello@helium.foundation) containing the following information:
