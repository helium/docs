...
Please refer to [Docker documentation](https://docs.docker.com/get-docker/) for installation instructions.
...
Run `docker-compose up` to start the server on [http://localhost:8080](http://localhost:8080). Utilize the default credentials to log in:
