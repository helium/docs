...
description:
  Overview of ChirpStack LNS configuration for Helium, with links to Docker Compose and Kubernetes
  setup guides.
...
both can be used in a variety of settings, the configurations provided here use Docker Compose to
run ChirpStack in a non-production setting and Kubernetes in a production setting.
