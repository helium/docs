...
additional LoRaWAN&trade; region. Although this tutorial demonstrates adding support for US915,
...
[Routing Rules Configuration Guide](/iot/run-an-lns/configure-routing-rules).
