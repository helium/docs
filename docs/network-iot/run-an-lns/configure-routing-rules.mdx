...
Finally, let's make sure you specify the port for each LoRaWAN region you plan on supporting on
...
In this example, we will explain how to add a US915 OTAA Class-A device. On ChirpStack, navigate to
...
configurations, please see the [Advanced Configuration](/iot/run-and-lns/advanced-configuration)
section.
