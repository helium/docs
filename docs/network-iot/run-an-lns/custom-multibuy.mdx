...
| `region`      | `region` | LoRaWAN region enum defined in [`region.proto`](https://github.com/helium/proto/blob/master/src/region.proto) (e.g., `US915`, `EU868`, `AU915`). |
...
Each route can have its own custom MultiBuy endpoint. This allows different filtering logic per
route if needed.
