...
Funding an OUI with Data Credits from HNT tokens can be performed int the Helium Wallet App or 
...
Funding an OUT with Data Credits requires HNT, as Data Credits can only be obtained using HNT. The
...
The Helium Wallet app can be used to swap HNT from one wallet to DC in a wallet.
