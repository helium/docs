...
Firstly add the Wallet address to the Address Book as a contact. This is the destination
...
The new DC balance amount in the recipient Wallet can be verified by looking at the Helium
Data Credit token balance of the wallet on https://explorer.solana.com/

You now have a funded OUI, it's now time to configure and deploy your LNS [here](configure-chirpstack).
