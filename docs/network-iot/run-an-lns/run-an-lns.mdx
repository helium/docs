...
OpenLNS is the platform that enables any compatible LoRaWAN&trade; Network Server (LNS) to use Helium's IoT
...
1. [Configure and deploy a LoRaWAN&trade; Network Server (LNS)](/iot/run-an-lns/configure-chirpstack)
...
handles the connectivity between LoRaWAN&trade; Network Servers and Hotspots (gateways).
