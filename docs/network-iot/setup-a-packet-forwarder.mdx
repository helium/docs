...
slug: /network-iot/setup-a-packet-forwarder
---
...
The ability to earn from [Proof of Coverage](/archive/blockchain/proof-of-coverage) with anything
other than a [Full Hotspot](/network-iot/hotspots-iot/full-hotspots) is not supported.

Building your own packet forwarder enables Data transfer rewards _only_, **if and only if** you
complete the setup process [here](/network-iot/hotspots-iot/data-only-hotspots).
...
You are now ready to set up the [Hotspot client](/network-iot/hotspots-iot/light-hotspots).
