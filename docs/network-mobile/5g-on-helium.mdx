...
reliable, high-bandwidth networks using technologies like [CBRS](/cbrs-radios) and Wi-Fi. We see
service providers as a critical component of this ecosystem rather than replacing service providers
altogether.
...
Interacting with MOBILE tokens is only possible using the [Helium Wallet App](/helium-wallet-app).
