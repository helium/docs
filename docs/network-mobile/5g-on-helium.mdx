...
may be scaled if overlapping coverage is provided. See the
[MOBILE Proof-of-Coverage](/mobile/proof-of-coverage) section for more details. Note thatconnecting
more than one Radio may require an additional networking switch. Refer to the 5G Hotspot Maker
installation guides for specific instructions.
...
updated to 230B from 250B in
[HIP-77](https://github.com/helium/HIP/blob/main/files/0077/token-emissions-as-of-solana-migration.pdf))
in the form of a pre-mine.

Information about token allocation can be found
[here](https://docs.helium.com/tokens/mobile-token/#token-allocation)
...
[GitHub](https://github.com/helium/HIP/blob/main/files/0075/mobile-emissions-schedule-HIP53-vs-HIP75.pdf).
...
earning MOBILE automatically as one "lump sum" to the associated Hotspot. Learn more about
calculating MOBILE Rewards in the [MOBILE Proof-of-Coverage](/mobile/proof-of-coverage)
documentation.
