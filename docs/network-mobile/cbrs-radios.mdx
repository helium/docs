...
Operation of the CBRS network will end on March 1st, 2025.

As outlined in HIP 139, the Helium community has reached an outcome for the handling of CBRS on the
Mobile Network. For eligible radios, this program offers an opportunity to receive Helium Hotspots
while retaining existing CBRS equipment.

Eligible CBRS radios may redeem WiFi radios:
[CBRS to Wi-Fi Trade-Up](https://www.helium.com/tradeup).
