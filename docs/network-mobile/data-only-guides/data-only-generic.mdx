...
3. **RCOI (Roaming Consortium OI)**: Add the consortium identifier if provided by your Hotspot 2.0
   service.
...
- **Fortinet**: Within “Wireless Controller > SSID,” enable Passpoint. Enter the relevant AAA
  details.
