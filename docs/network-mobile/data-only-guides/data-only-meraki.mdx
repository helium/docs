...
9. Change the number 1 drop down for **NAS ID** to **Custom** and enter the NAS-ID you got during
   onboarding
10. Click the x to remove number 2 in that list which says **SSID Number**
    <figure className="screensnippet-wrapper">
      <img
...
## Build Hotspot2.0 Config

1. Click on **Wireless** and navigate to **Hotspot2.0**
...
2. Change the toggle for **Hotspot2.0** to **Enabled**
...
10. Final Hotspot2.0 settings should look like this:
