...
<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/radsecproxy/Helium RADIUS Options-Secure Sites Single RSP.png')}
...
<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/radsecproxy/Helium RADIUS Options-Independent sites many RSPs.png')}
    style={{ maxHeight: '500px' }}
    className="add-border-radius add-shadow add-shadow-margin"
  />
</figure>
...
<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/radsecproxy/Helium RADIUS Options-Secure Sites Single VPN.png')}
    style={{ maxHeight: '500px' }}
    className="add-border-radius add-shadow add-shadow-margin"
  />
</figure>
...
<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/radsecproxy/Helium RADIUS Options-Independent sites many VPNs.png')}
    style={{ maxHeight: '500px' }}
    className="add-border-radius add-shadow add-shadow-margin"
  />
</figure>
