...
sidebar_label: Catalyst 5520
description:
  Configure a Cisco Catalyst 5520 (AireOS) controller with Passpoint, RadSecProxy, and Hotspot 2.0
  for Helium Mobile.
...
- ACLs or firewalls allow the 5520 WLC Controller and Docker container to communicate over UDP on
  ports 1812 and 1813
...
To start, log in to your Cisco 5520 Dashboard in your browser. This will be our starting point for
...
3. Configure the **NAS-ID** to the value shared with you by Helium
...
3. In the **Layer 2 Security** dropdown choose **WPA2 + WPA3**
...
5. In the dropdown for **Network Type** choose **Chargeable Public**
6. In the dropdown for **IPv4 Type** choose **Single NATed Private** or the most applicable option
   for your network
7. In the dropdown for **IPv6 Type** choose **Not Available** or the most applicable option for your
   network
...
sent by the Helium team.

:::

10. **Click** on the **hellohelium.com** realm you just created
11. Set **EAP Method** to **EAP-TLS**, then click on **Add**. The EAP method appears in the EAP
    Index. If it asks for a sub-method, choose **Certificate**
