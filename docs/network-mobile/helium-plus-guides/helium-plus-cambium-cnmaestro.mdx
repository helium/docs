---
id: helium-plus-cambium-cnmaestro
title: Cambium cnMaestro Conversion Guide
pagination_label: Cambium cnMaestro Conversion Guide
sidebar_label: Cambium cnMaestro
description:
  Configure Cambium cnMaestro with RadSecProxy, WPA3 Enterprise, and Passpoint for Helium Mobile.
image: https://docs.helium.com/img/link-image.png
slug: /mobile/helium-plus-cambium-cnmaestro
---
...
RADIUS messages used to authenticate users and for session accounting are transmitted unsecured over
UDP by default. By directing these messages internally within your secure network to a
...
<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/cambium/cambium-home-page.png')}
...
<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/cambium/cambium-wlan-settings.png')}
    style={{ maxHeight: '500px' }}
    className="add-border-radius add-shadow add-shadow-margin"
  />
</figure>
...
7. Under **Advanced Settings → NAS-Identifier**, select **Custom** and enter the **NAS ID** provided
...
5. Under **NAI Realm List**, click **Add New**:
   ...
   Click **Add New** again for the next NAI Realm:
...
7. Scroll down to **IP Address Type Information**:
   - **IPv4 Type:** `Double NAT`
   - **IPv6 Type:** `Not Available`

<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/cambium/cambium-ipv.png')}
    style={{ maxHeight: '500px' }}
    className="add-border-radius add-shadow add-shadow-margin"
  />
</figure>
...
4. Scroll down to **WLAN** and add the `Helium Enterprise` WLAN we created if it's not already
   there.

<figure className="screensnippet-wrapper">
  <img
    src={useBaseUrl('img/mobile-data-only/cambium/cambium-final-step.png')}
    style={{ maxHeight: '500px' }}
    className="add-border-radius add-shadow add-shadow-margin"
  />
</figure>
