...
1. Build Meraki Helium Passpoint SSID
   1. Import Helium CA certificate and export Meraki CA certificate to the Helium team
   2. Build a new SSID
...
1.  Log in to your Meraki Dashboard in your browser
...
5.  Click on **Upload CA certificate** and upload the Helium CA certificate file sent to you by the
    Helium team
    <figure className="screensnippet-wrapper">
      <img
