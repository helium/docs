---
id: helium-plus-ruckus
title: Ruckus Conversion Guide
pagination_label: Ruckus Conversion Guide
sidebar_label: Ruckus
description:
  Configure a Ruckus SmartZone controller with RadSec, Hotspot 2.0, and Passpoint for Helium Mobile.
image: https://docs.helium.com/img/link-image.png
slug: /mobile/helium-plus-ruckus
---
...
1. Build Ruckus Helium Passpoint SSID
   1. Install Certs
   2. Set Up RadSec Proxy
   3. Configure HS2.0 Profile
   4. Build New SSID
...
To start, log in to your Ruckus Dashboard in your browser. This will be our starting point for all
major steps below.
...
5. Next, on the sub-menu bar, select the **SZ as Client Certificate** tab
...
6. Select **Client Certificate** from the drop-down to be **Helium_radsec_client**
...
6. Click Next
7. Leave online signup disabled, then click Next
...
8. In **Authentication** for both **no-match** and **unspecified**:
   ...
   2. Click configure
   3. Choose Helium_Radsec from the drop-down
...
12. Review and make sure it matches the image below.
...
7. Under **Hotspots 2.0 Profile**, in **Hotspot 2.0 profile** click **\+**
   ...
   6. Select **IPv4 Double NATed private address** (or as applicable to your network)
...
8. Click **OK** and you should see a configuration like the image below.
...
9. Under **RADIUS Options**
   1. **NAS-ID \-\> User-Defined \>** enter your NAS-ID per the Helium onboarding spreadsheet.
