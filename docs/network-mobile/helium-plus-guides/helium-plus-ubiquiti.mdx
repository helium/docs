...
<figure className="screensnippet-wrapper">
  <img
    ...
    className="add-border-radius add-shadow add-shadow-margin"
  />
  <figcaption>Accounting checkbox greyed out—workaround: save and reopen the RADIUS profile.</figcaption>
</figure>
<br />
...
12. Under ***NAS ID*** Enter the NAS-ID used during Helium onboarding in the **Custom** field of **NAS-ID**.
