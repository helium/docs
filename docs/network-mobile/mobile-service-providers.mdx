...
It established the Mobile subnetwork, which handles all MOBILE Rewards emissions, earning Rewards,
...
high-bandwidth networks using technologies such as CBRS and Wi-Fi.
...
Check out the blog post about [Mobile Proof-of-Coverage Roadmap](https://blog.helium.com/mobile-proof-of-coverage-the-road-ahead-73a25601a13d) for more
information about achieving better quality coverage for subscribers.
...
This will lock 500M MOBILE and create your carrier. Once this is done, you must have the carrier
...
The 500M MOBILE locked by a service provider is not staked as a governance token and the locked MOBILE 
wallet does not receive vote escrowed MOBILE usable for network voting rights.
