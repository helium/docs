...
- **Users:** Users of the network are people who get their mobile service from a participating
  ...
  Network), Movistar, or others. Users consume voice, text, and data services using a smartphone
  that supports Passpoint. Users are also referred to as 'subscribers'.
