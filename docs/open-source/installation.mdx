...
External link: [Node.js](https://nodejs.org/en/download) version >= 10.15.1
...
Download software:
External link: [Yarn](https://yarnpkg.com/getting-started/install) version >= 1.5
...
:::warning
You can not use `git add .` moving forward at the root of the repository. There are yarn files in the root of the project that should not be committed
:::
