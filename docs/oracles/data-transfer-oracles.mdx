...
Each OUI is registered in the Config Service, and may define multiple routes.
...
See [these instructions] (docs/oracles/oui-owner-instructions.mdx) on how to build the Config
Service for the latest Console release.
