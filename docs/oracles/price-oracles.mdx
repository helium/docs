...
are required on-chain as the price is needed to calculate everything from burning HNT for Data
...
existing Helium L1 price oracles continue to contribute market data.
...
The current oracle prices can be viewed here:
