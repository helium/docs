...
<img alt="Agricultural" src={useBaseUrl('../../static/img/projects/agricultural.png')} /><br/>
...
<img alt="Dashboards" src={useBaseUrl('../../static/img/projects/dashboard.png')} /><br/>
...
<img alt="Environmental" src={useBaseUrl('../../static/img/projects/environmental.png')} /><br/>
...
<img alt="Healthcare" src={useBaseUrl('../../static/img/projects/healthcare.png')} /><br/>
...
<img alt="Industrial" src={useBaseUrl('../../static/img/projects/industrial.png')} /><br/>
...
<img alt="Misc" src={useBaseUrl('../../static/img/projects/misc.png')} /><br/>
...
<img alt="Security" src={useBaseUrl('../../static/img/projects/security.png')} /><br/>
IoT is heavily used in asset tracking and security.

### [Tracking](/docs/projects/tracking)
<img alt="Tracking" src={useBaseUrl('../../static/img/projects/tracking.png')} /><br/>
...
<img alt="Utility" src={useBaseUrl('../../static/img/projects/utilities.png')} /><br/>
