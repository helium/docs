...
<img alt="Agricultural" src={useBaseUrl('../../static/img/projects/topic_agricultural.png')} /><br/>
...
<img alt="Dashboards" src={useBaseUrl('../../static/img/projects/topic_dashboard.png')} /><br/>
...
<img alt="Environmental" src={useBaseUrl('../../static/img/projects/topic_environmental.png')} /><br/>
...
<img alt="Healthcare" src={useBaseUrl('../../static/img/projects/topic_healthcare.png')} /><br/>
...
<img alt="Industrial" src={useBaseUrl('../../static/img/projects/topic_industrial.png')} /><br/>
...
<img alt="Misc" src={useBaseUrl('../../static/img/projects/topic_misc.png')} /><br/>
...
<img alt="Security" src={useBaseUrl('../../static/img/projects/topic_security.png')} /><br/>
IoT is heavily used in asset tracking and security.

### [Tracking](/docs/projects/tracking)
<img alt="Tracking" src={useBaseUrl('../../static/img/projects/topic_tracking.png')} /><br/>
...
<img alt="Utility" src={useBaseUrl('../../static/img/projects/topic_utilities.png')} /><br/>
