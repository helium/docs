...
<img alt="Agricultural" src={useBaseUrl('img/projects/agricultural.png')} /><br/>
...
<img alt="Dashboards" src={useBaseUrl('img/projects/dashboard.png')} /><br/>
...
<img alt="Environmental" src={useBaseUrl('img/projects/environmental.png')} /><br/>
...
<img alt="Healthcare" src={useBaseUrl('img/projects/healthcare.png')} /><br/>
...
<img alt="Industrial" src={useBaseUrl('img/projects/industrial.png')} /><br/>
...
<img alt="Misc" src={useBaseUrl('img/projects/misc.png')} /><br/>
...
<img alt="Security" src={useBaseUrl('img/projects/security.png')} /><br/>
IoT is heavily used in asset tracking and security.

### [Tracking](/docs/projects/tracking)
<img alt="Tracking" src={useBaseUrl('img/projects/tracking.png')} /><br/>
...
<img alt="Utility" src={useBaseUrl('img/projects/utilities.png')} /><br/>
