...
[PoC model is relatively straightforward](https://docs.helium.com/5g-on-helium/mobile-poc) and based
...
Each subDAO is responsible for defining its Treasury Reserve DNT Market Making Curve.
