...
the Helium Network has successfully migrated to the Solana blockchain on **April 18, 2023, 9am PST** (16:00 UTC).
This strategic move, voted in by the community, aims to capitalize on Solana's scalability, low
transaction costs, and high-performance capabilities, including its fast transaction throughput and
