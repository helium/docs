...
Alternatively, you can use the [Migration Widget](https://docs.helium.com/solana/migration/exchange#mapping-helium-wallets-to-solana-wallets)
or [command line utility](https://github.com/helium/helium-program-library/releases/tag/v0.0.27-migration-cli)
