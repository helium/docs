...
description: Helium Blockchain Node Documentation
...
As of version [1.1.88](https://github.com/helium/blockchain-node/releases/tag/1.1.88) users can test the migration of their `blockchain-node` wallet to a Solana
Paper Compatible Wallet. Follow the below instructions to migrate your wallet on testnet.
