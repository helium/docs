...
Helium wallets use the same ED25519 curve as Solana wallets. This means that helium public keys
and secret keys can be mapped directly to a Solana based wallet. 
