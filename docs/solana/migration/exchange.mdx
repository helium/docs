...
The [Migration Widget](https://docs.helium.com/solana/migration/exchange#mapping-helium-wallets-to-solana-wallets) 
and description provided below have been updated to reflect Solana Mainnet.
