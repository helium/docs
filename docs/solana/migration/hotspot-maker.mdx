...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    <div class="col col--6" style={{ marginBottom: 0 }}>
      <p>
        Maker Wallets will need <code>DC</code> to pay onboarding and assert fees. DC can be aquired
        by either
        <ul>
          <li>Depositing DC into the Maker Wallet on the current Helium L1.</li>
          <li>
            Use the Helium Wallet App to swap HNT for DC, using the Maker Wallet in the{' '}
            <code>recipient</code>
            field.
          </li>
        </ul>
      ...
      <img
        ...
        className="appscreen"
        src={useBaseUrl('img/wallet-app/swap-buttons.png')}
      />
    </div>
    <div class="col col--6" style={{ marginBottom: 0 }}>
      <img
        alt="Helium Wallet app token swap screen"
        className="appscreen"
        src={useBaseUrl('img/wallet-app/hnt-dc-swap.png')}
      />
    </div>
  </div>
</div>
