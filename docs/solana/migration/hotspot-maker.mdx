...
Maker Wallets will need `DC` to pay Helium onboarding and assert fees. DC can be aquired by either
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      />
      <p>
        Use the Orange <code>Swap</code> button on the Helium Wallet App homescreen to swap HNT for
        DC.
      </p>
    </div>
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      />
      <p>
        Select <code>HNT</code> in the first Dropdown to swap for <code>DC</code>.
      </p>
      <p>
