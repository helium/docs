...
following below. Note that Data Only Hotspots will not be rewarded:

- Participated in PoC activity (Witnessing & Challenges), including:
...
- Transferred LoRaWAN data and been rewarded for it (this includes Data Only Hotspots)
