...
[3X veHNT landrush bonus.](/mine-hnt/validators/validators-and-voting-power/#is-there-a-staking-genesis-period)
:::
...
Before starting these steps, close the Ledger Live application or the migration will fail.
