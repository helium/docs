...
You can test the Helium-Solana Ledger migration before Helium's migration onto Solana Mainnet on April 18th, but doing so will use Solana Devnet, where your tokens are not real. You will not be able to migrate your Helium tokens to Solana Mainnet until after the Helium migration completes on April 19th. If you test the Ledger migration before then, you will need to re-migrate on or after April 19th.

You can migrate your tokens any time after April 19th. There is no need to rush to migrate your tokens unless you want to lock up HNT early to receive the [3X veHNT landrush bonus.](/mine-hnt/validators/validators-and-voting-power/#is-there-a-staking-genesis-period)
:::
:::tip Video Walkthrough

There is a [video walkthrough of the full process here](https://youtu.be/Sl7UBStRmpA).
...
- [Helium-Solana Ledger App](https://github.com/helium/app-helium-solana) now available from Ledger Live (ensure Developer Mode is enabled)
