...
There is a [video walkthrough of the full process here](https://youtu.be/wZLURMKVp9w).
...
5. Change `My ledger provider` to `4`
6. Install the Helium-Solana app as you normally would,
   [following the instructions here](/wallets/ledger).

:::info Ledger Icon and Providers

While using the testing provider, the icon for the app will not appear properly on your Ledger.

Do not install any other apps on the `4` provider as other developer teams use this release channel.
