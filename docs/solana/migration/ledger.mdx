...
Note that, while using the testing provider, the icon for the app will not appear properly on your ledger. Additionally, do not install any other apps on the `4` provider as other developer teams use this release channel. 
