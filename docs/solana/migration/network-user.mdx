...
During the Solana Migration, users may still purchase Data Credits with a credit card on Helium Console.
However, users will be unable to acquire DC through a direct HNT burn on Helium Console. If you need
