...
- Existing Validator stakes will be automatically be migrated to veHNT positions during the
  transition
- Acton must be taken to return the HNT (unstake) from a veHNT position
- Action must be taken to delegate veHNT to enable MOBILE Network and/or IOT Network emissions
...
to Solana is completed.

One of the impacts of the passing of HIP-70 and transitioning L1 is that the role Validators play as
we know it will no longer be required, and Validators are sunsetted by the end of April 18th 2023
...
HNT amount and lock-up period. Your HNT will become veHNT and remain entirely in your wallet's
custody. veHNT ownership is represented by a non transferable Solana NFT held in your wallet.
...
See the [Ledger Migration Docs](/solana/migration/ledger) The latest information on the procedure
for Ledger users.
