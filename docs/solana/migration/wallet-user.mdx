...
Ledger Wallet users to migrate their wallets to the Solana blockchain. By following the steps, users
can smoothly access their HNT, DC, MOBILE, IOT, and Hotspots on the new platform.

## For Helium App Users

The Helium app will require a migration to the [Helium Wallet app.](https://docs.helium.com/wallets/helium-wallet-app) Wallet migration is necessary to
...
the account page. You can also create or import multiple accounts to a maxium of 10 on the Helium Wallet app.
