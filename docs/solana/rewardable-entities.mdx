...
cryptographic proof to the blockchain that verifies the NFT and ownership. In other words, instead of
...
servers.  
**This example will not work unless you use an appropriate RPC provider such as
