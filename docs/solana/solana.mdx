...
The following are migration guides for different users of Helium:
  ...
  * [Hotspot Owner](./migration/hotspot_owner.mdx)
  * [Maker](./migration/maker.mdx)
  * [Exchange](/solana/migration/exchange)
  * [LoRaWAN Network User](./migration/network_user.mdx)
  * [Application Builder](./migration/application_builder.mdx)
  * [Governance Participant](./migration/governance.mdx)
  * [Ledger User](./migration/ledger.mdx)
