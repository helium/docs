...
description:
  Data Credits (DC) explained — fixed USD value, HNT burn mechanism, and cost structure for IoT and
...
| Action                                                  | Fee   |
| ------------------------------------------------------- | ----- |
| WiFi Indoor Onboard <sub>(Included with Hotspot)</sub>  | $20   |
| WiFi Outdoor Onboard <sub>(Included with Hotspot)</sub> | $30   |
