...
[burn and mint economics](/tokens/hnt-token/#burn-and-mint-economics) in the HNT token
documentation.
...
DC can be delegated to other Helium Wallets but these must be IOT LNS provider Wallets in
arrangement with the LNS provider.
...
| Wifi Indoor Onboard  | $10<sup>(</sup>[^4]<sup>)</sup> |
| Wifi Outdoor Onboard | $10<sup>(</sup>[^4]<sup>)</sup> |
