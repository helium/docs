...
reported by the [Pyth](https://insights.pyth.network/price-feeds/Crypto.HNT%2FUSD). The tool below
demonstrates the HNT to DC conversion based on the price of HNT.
