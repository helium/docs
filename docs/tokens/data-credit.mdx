...
| Assert Location   | $10                                       |
| OUI               | $100                                      |
| DevAddr           | $12.50 ($100)<sup>(</sup>[^1]<sup>)</sup> |

[^1]: DevAddrs must be purchased in slabs of 8.<br />
[HIP-116](https://github.com/helium/HIP/blob/main/0116-lorawan-device-address-price-adjustment.md) Set 
the Fees for OUI and DevAddr purchasing to use IOT token.
