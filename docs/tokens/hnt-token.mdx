...
fluctuate based on the USD price of HNT as reported by the HNT [Price Oracles][price-oracles].

The tool below demonstrates the HNT to DC conversion based on the oracle price of HNT.
