...
the Net Emissions Target of the previous day and smoothes it. The target amount of HNT is then
...
HNT burned is 10,000 HNT `hnt_burn(today)`, then the result is: (400 x 6/7) + (10,000 x 1/7) =
1,771.429 `net_emissions_target(today)`, but will be Max capped at 1,643.83561643 HNT and become
`hnt_net_emissions(today)`.
...
If yesterday's smoothed HNT burn number was 1,650 HNT and today's HNT burned is 200 HNT, then the
result is: (1,650 x 6/7) + (200 x 1/7) = 1,442.857143 and is under the cap.
...
Smoothing the HNT burn from previous days to today has resulted in more HNT Net Emissions today than
were HNT burned today. These came from yesterday's pooled number.

Tomorrow, the uncapped number (1,442.857143) will become yesterday's smoothed HNT burn number.

#### Example 3

If yesterday's smoothed HNT burn number was 1,440 HNT and today's HNT burned is 2,000 HNT, then the
result is: (1,440 x 6/7) + (2,000 x 1/7) = 1,520 HNT and is under the cap

Therefore, 1,520 is today's actual Net Emission's and 2,000 - 1,520 = 480 HNT will be burned today.
