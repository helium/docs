...
number for today. This has an effect that large burns on one day can increase Net Emissions over 
several days rather than just one day.
...
If yesterday's smoothed HNT burn fnumber was 400 HNT `net_emissions_target(yesterday)` and today's 
