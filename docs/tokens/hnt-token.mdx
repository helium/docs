...
the Net Emissions Target of the previous day and smoothes it. The target amount of HNT is then re-emitted as 
Net Emissions, up to the cap of 1,643.83561643 HNT.
