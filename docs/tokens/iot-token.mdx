...
:::important IOT emissions ceased on January 29, 2025, in accordance with [HIP-138][hip-138].

Network participants are directly rewarded in HNT tokens from the HNT awarded to the IOT Network by
the utility score.

IOT Tokens remain redeemable for HNT via the Subnetwork Treasury pool allocated during the IOT
emission period.
...
by dividing the
[current total amount of IOT tokens in existence](https://solscan.io/token/iotEVVZLEywoTn1QdwNPddxPWszn3zFhEot3MfL9fns)
by the current amount of
[HNT in the IOT Network treasury](https://solscan.io/account/CpyoYpaEZc8DvmkNWNZWfkQDFvGAvHp5mhtEhwGQhkTk).
The result tells how many IOT is required to be burned to receive each HNT token from the network
treasury.

$$\text{IOT per HNT} = \frac{\text{Total amount of IOT tokens existing}}{\text{Total amount of HNT in IOT treasury}}$$

Now that the IOT token has ceased minting and there is no distribution of HNT to the IOT treasury
then the redemption or floor rate of IOT to HNT is stabilized. And for as long as there is HNT in
the IOT treasury then the IOT token will have a value.
...
The emissions schedule was created in [HIP-52][hip-52-emissions] and confirmed in
[HIP-77][hip-77-emissions] and is as follows:
...
| 3 (2025-1) | 118B (to 29th)    | As HNT     | 27%                                            | 53%                                        | 7%                                   | 7%              | 6%           |
| 4 (2025-8) | N/A               | As HNT     | 25.5%                                          | 54.5%                                      | 7%                                   | 7%              | 6%           |
| 5 (2026-8) | N/A               | As HNT     | 24%                                            | 56%                                        | 7%                                   | 7%              | 6%           |
| 6 (2027-8) | N/A               | As HNT     | 22.5%                                          | 57.5%                                      | 7%                                   | 7%              | 6%           |
| 7 (2028-8) | N/A               | As HNT     | 21%                                            | 59%                                        | 7%                                   | 7%              | 6%           |
...
[hip-52-emissions]: https://github.com/helium/HIP/blob/main/0052-iot-dao.md#emissions-curve
