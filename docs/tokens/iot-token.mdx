...
**And network participants will be directly rewarded in HNT tokens in the percentages defined in the
IOT emissions schedule, from the HNT awarded to the IOT network by the Utility score, initially 
defined in [HIP-51][hip-51], and subsequently updated in [HIP-141][hip-141]**
...
[hip-141]: https://github.com/helium/HIP/blob/main/0141-single-token-governance-and-release-proposals.md#migrating-to-a-protocol-score-based-only-on-delegation
