...
:::important MOBILE emissions ceased on January 15, 2025, in accordance with [HIP-138][hip-138].
...
by dividing the current amount of HNT in the network treasury by the current total amount of MOBILE
tokens in existence. The result tells how much HNT one will get per MOBILE token given up at the
network treasury.
