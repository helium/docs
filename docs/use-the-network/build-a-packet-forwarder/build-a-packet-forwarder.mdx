...
Packet forwarders are designed for sensor developers to test usage without needing a Hotspot. If you're interested in using the Helium network and earning from data transfer from your existing hardware, please check out the [Light Hotspots](https://docs.helium.com/mine-hnt/light-hotspots/).
