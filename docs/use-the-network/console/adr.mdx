...
<img src={useBaseUrl("img/use-the-network/console/console-adr-label-settings.png")} />

Next you will be presented with the Label settings window show below, click the ADR tab.

<img src={useBaseUrl("img/use-the-network/console/console-adr-label-settings-adr.png")} />

Here you can toggle the Allow ADR setting and apply the changes to the Label settings. Last, if you don't already have the Label attached to your device or devices then you will need to do that before these setting are applied.