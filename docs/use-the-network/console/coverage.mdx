...
:::info To learn more about Coverage in Console, check out our Tips & Tricks video
...
[here](/use-the-network/console/profiles/) and choose to purchase all packets. Assuming there is
sufficient Data Credit balance, Console will purchase packets from all the Hotspots that heard the
...
`My Hotspot` list check
[here](https://docs.helium.com/use-the-network/console/coverage/#identify-hotspots-that-hear-devices).
