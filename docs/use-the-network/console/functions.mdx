...
values. For every transmission, we want to pack as much information into as few bytes as possible.
Because of this, there are special encoding standards specifically made for sending common IoT
device data such as
...
<img src={useBaseUrl('img/use-the-network/console/console-functions-create.png')} />
...
<img src={useBaseUrl('img/use-the-network/console/console-functions-enter-script.png')} />
