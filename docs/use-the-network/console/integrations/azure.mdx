...
# Azure IoT Central (Staging Only)
...
After providing a name and completing the integration, make sure the device/label is mapped to the Azure IoT Central Integration on the Flows page. More information about Flows [here](https://docs.helium.com/use-the-network/console/flows/).
