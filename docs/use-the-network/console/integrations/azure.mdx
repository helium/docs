...
<img
  src={useBaseUrl('img/use-the-network/console/integrations/integrations-add-helium-console.png')}
/>

Choose the **Azure IoT** integration icon.

<img
  src={useBaseUrl('img/use-the-network/console/integrations/integrations-azure-helium-console.png')}
/>
