...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-select-http.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-http-request-bin.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-http-details.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-http-downlink-details.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-http-downlink-button.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-http-downlink-tool-expanded.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-http-downlink-event.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/console/integrations/console-integrations-http-downlink-postman-example.png"
  )}
/>
