...
Please note that both Actuators types inherit from AnalogSensor DataType, eg.
using 2 bytes integers with 0.01 precision. This means a Digital Actuator set to
