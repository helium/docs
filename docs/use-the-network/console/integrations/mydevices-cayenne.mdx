...
the Helium network as well as connected it the myDevices Cayenne integration. If
you haven't done so yet, start [here](../adding-devices). Once you have a device
added on Console and you have verified that packets are being received, you can
then proceed to add the device on Cayenne.
...
You must select the Helium Network **before** searching for your device, else
you may add your device on the wrong network and will not receive data. :::
