...
attaches to the device must also be applied to the device. Please see attached
link for more information on creating a Function.
https://docs.helium.com/use-the-network/console/functions/

### How do I manage my Hotspots on Console?

Hotspots can’t be managed or connected on Console, you will need to use the
Helium app to manage your Hotspots.
