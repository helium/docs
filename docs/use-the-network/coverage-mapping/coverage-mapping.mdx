...
If the hostspots that you are mapping are your own, those data credits are paid back to your hotspots in the form of HNT. Hotspots earn HNT for data packets they transfer, for mapping or otherwise.
...
* [IoWe](https://www.internetofwe.net/product-page/helium-coverage-mapper)
...
* [Adeunis Field Test Device](/use-the-network/coverage-mapping/adeunis-mapper)
* [Dragino LGT-92](/use-the-network/coverage-mapping/mappers-quickstart)
* [Fiz-Tech Mapper](https://fiz-tech.net/search?type=tag&q=Mapper)
* [Glamos Walker](https://glamos.eu/product/walker/)
* [RAK Wireless RAK7200](https://store.rakwireless.com/products/rak7200-lpwan-tracker?variant=29669491867693)
...
* [Disk91 Mapper](https://shop.ingeniousthings.fr/products/helium-lorawan-field-tester-and-mapper-kit)
    * [Disk 91 Mapper Tutorial](https://www.disk91.com/2021/technology/lora/low-cost-lorawan-field-tester/)
* Helium Dev Kit / RAK WisBlock [via RAKWireless](https://store.rakwireless.com/products/helium-developer-kit), [via ParleyLabs](https://shop.parleylabs.com/collections/iot-developers-products/products/helium-wisblock-connected-kit)
* [Heltec CubeCell](https://heltec.org/project/htcc-ab02s/)
