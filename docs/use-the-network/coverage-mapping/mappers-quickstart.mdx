...
1. Enter the Mappers API Endpoint URL (Required)
...
[here](https://www.dragino.com/downloads/downloads/LGT_92/Decoder/LGT92-v1.6.4_decoder_TTN.txt).
...
2. Copy and paste the complete decoder function provided by the manufacturer
   found
   [here](https://www.dragino.com/downloads/downloads/LGT_92/Decoder/LGT92-v1.6.4_decoder_TTN.txt) or below.
  ...
  ```  
   ...
   specification [here](/use-the-network/coverage-mapping/mappers-api).
