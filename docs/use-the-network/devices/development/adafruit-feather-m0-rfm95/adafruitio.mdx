...
slug: /use-the-network/devices/development/adafruit-feather-m0-rfm95/adafruitio
---
...
the Console quickstart [here](/use-the-network/console/quickstart).
This will ensure you have a Console account and have created a new
device.
...
This step will cover adding an antenna, jumping pins on the LoRaWAN radio, and finally
wiring the DHT22 temperature and humidity sensor. Below is a breadboard wiring diagram
that you can reference for your setup.

<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/adafruit-feather-m0-rfm95/adafruit-feather-adafruitio-breadboard.png"
  )}
/>
...
Connect the signal pin `2` of the DHT22 sensor to pin `12` on the feather board. You will also need to 
add a pull up resister (20-50k) between the signal pin `2` of the DHT22 sensor and the 3.3V supply.
Last, connect the power(3.3V or 5V) and ground pins. Please reference the breadboard diagram above.
...
1. Navigate to Library Manager \(**Sketch &gt; Include Library &gt; Manage Libraries**\).
2. In the search box, type **DHT22 sensor library** into the search, select the version shown below, and click Install.

<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/adafruit-feather-m0-rfm95/adafruit-feather-m0-rfm95-arduino-add-dht22-library.png"
  )}
/>
...
1. Navigate to Library Manager \(**Sketch &gt; Include Library &gt; Manage Libraries**\).
2. In the search box, type **CayenneLPP** into the search, select the version shown below, and click Install.

<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/adafruit-feather-m0-rfm95/adafruit-feather-m0-rfm95-arduino-add-cayennelpp-library.png"
  )}
/>
...
To create a new Arduino sketch, open your Arduino IDE, \(**File &gt; New\).** Next, replace the template sketch with the sketch found [here](https://github.com/helium/longfi-arduino/blob/master/Adafruit-Feather-M0-RFM95/longfi-us915-cayenne-dht22/longfi-us915-cayenne-dht22.ino), copy and paste the entirety of it.
...
Congratulations! You have just transmitted data on the Helium network! The next step is to create and attach the AdafruitIO integration.
...
Now that we have our integration created, the last step is to attach the label to our
device. To do this, navigate your device page and click the `Add Label` button shown
below.

<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/adafruit-feather-m0-rfm95/adafruit-feather-m0-rfm95-console-add-label.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/adafruit-feather-m0-rfm95/adafruit-feather-m0-rfm95-console-select-label.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/adafruit-feather-m0-rfm95/adafruit-feather-m0-rfm95-adafruitio-feeds.png"
  )}
/>
