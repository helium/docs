...
[here](/use-the-network/console/quickstart). This will ensure you have a Console account and have
...
<img
  src={useBaseUrl('img/use-the-network/console/integrations/integrations-select-adafruitio.png')}
/>
...
<img
  src={useBaseUrl('img/use-the-network/console/integrations/integrations-adafruitio-mykey.png')}
/>
...
be unique for every Helium device. You can use any of the the available template tags which are auto
...
<img
  src={useBaseUrl('img/use-the-network/console/integrations/integrations-adafruitio-label.png')}
/>
