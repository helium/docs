...
### Portenta LoRaWan Base64 Encoded Sketch
 ...
 <br><textarea rows=10 cols=70 NOWRAP>
/*
...
This example is easer than the above but less flexible. The decoder and the feed names are chosen for you and can't be changed, but easy to setup is often nice.
