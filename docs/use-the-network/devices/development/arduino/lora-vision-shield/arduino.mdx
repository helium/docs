...
### Setup Helium Console for Adafruit http
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/arduino/portenta/helium-adafruit-integration.png"
  )}
/>


You will be entering: 1. a name for the integration, 2. The adafruit Webhook copied earlier 3. Some JSON code to get data from the decoder
