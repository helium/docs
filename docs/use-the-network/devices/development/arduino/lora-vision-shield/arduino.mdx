...
After making a [Helium Console](https://console.helium.com) login, you we'll need select a new device "+" and  fill in the SECRET_APP_EUI\(lsb\), and SECRET_APP_KEY\(msb\), written exactly as you see them 
