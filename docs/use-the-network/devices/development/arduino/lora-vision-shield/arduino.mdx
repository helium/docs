...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/arduino/lora-vision-shield/adafruit-feed.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/arduino/lora-vision-shield/adafruit-webhook.png"
  )}
/>
