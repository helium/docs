...
Try not to have to remove and replace the antenna very often. the uFL connectors are rated for 30 connection cycles, but be careful when connecting/disconnecting to not rip the pads off the PCB
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/arduino/portenta/helium-keys.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/development/arduino/portenta/helium-console-debug.png"
  )}
/>
