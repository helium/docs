...
slug: /use-the-network/devices/development/heltec/cubecell-dev-board/platformio
---
...
code below. A console quick start guide can be found [here](/use-the-network/console/quickstart).
