...
_**If you are using Windows 10**_. Do _**NOT**_ install the Arduino IDE from the
Microsoft App Store.

Please install the original Arduino IDE from the
[Arduino official website](https://www.arduino.cc/en/Guide/Windows)​!

The Arduino app from the Microsoft App Store has problems using third party
