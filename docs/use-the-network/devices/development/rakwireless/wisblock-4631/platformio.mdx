...
type, the [RAK Wireless WisBlock](https://store.rakwireless.com/pages/wisblock) family of boards.
...
WisBlock components. Follow on RAK Wireless products may work but have not been tested at this
point.
