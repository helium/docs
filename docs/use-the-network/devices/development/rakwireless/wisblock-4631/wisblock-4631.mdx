...
description:
  The RAK4631 WisBlock Starter Kit delivers a powerful Nordic nRF52840 MCU with Bluetooth 5 paired
  to the latest LoRa® transceivers from Semtech, the SX126x series.
...
<img
  src={useBaseUrl('img/use-the-network/devices/development/rakwireless/wisblock-starter-kit.png')}
/>
