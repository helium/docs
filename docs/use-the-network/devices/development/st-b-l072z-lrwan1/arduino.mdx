...
<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-board.png')}/>
...
<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-resistor.jpg')}/>
...
<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-core-pref-arduino.png')}/>
...
<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-console.png')}/>

At the top of the sketch, replace the three **FILL\_ME\_IN** fields, with the matching field from Console, example shown below.

<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-arduino-code.png')}/>
...
<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-upload.png')}/>
...
<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-serial.png')}/>
...
<img src={useBaseUrl('img/use-the-network/devices/development/st-b-l072z-lrwan1/st-disco-console-events.png')}/>
