...
### Software
The following products are required. Refer to the [Getting started with Helium and PlatformIO](/use-the-network/devices/development/helium-platformio/helium-platformio-gettingstarted) guide for details.
