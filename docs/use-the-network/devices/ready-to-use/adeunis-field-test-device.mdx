...
<img src={useBaseUrl('img/devices/ready-to-use/adeunis-field-test-device.png')}/>
...
To start, you'll need to add your device to Console. You should have been provided with a DevEUI, AppEUI, and AppKey from the seller of the device.
[//]: # Follow our [quickstart ](../../console/quickstart.md)for instructions on how to add a new device to Console.
...
<img src={useBaseUrl('img/devices/ready-to-use/realterm-settings.png')}/>
...
<img src={useBaseUrl('img/devices/ready-to-use/send-button.png')}/>
...
<img src={useBaseUrl('img/devices/ready-to-use/send-ascii.png')}/>
...
<img src={useBaseUrl('img/devices/ready-to-use/realterm-at-commands.png')}/>
...
<img src={useBaseUrl('img/devices/ready-to-use/console-output.png')}/>
