...
<img src={useBaseUrl('img/devices/ready-to-use/digital-matter-lorawan001.png')} />
</div>
<div style={{textAlign: 'right'}}>
<img src={useBaseUrl('img/devices/ready-to-use/digital-matter-lorawan002.png')} />
</div>

## Introduction

The [Digital Matter Oyster](https://www.digitalmatter.com/devices/oyster-lorawan/)/[Yabby](https://www.digitalmatter.com/devices/yabby-lorawan/) are rugged IP67 rated battery powered GPS tracking devices. This guide will show you the hardware and software setup steps required to provision and onboard these devices on the Helium Network.
...
The Oyster uses a [FTDI TTL to USB Serial Converter Cable](https://www.ftdichip.com/Support/Documents/DataSheets/Cables/DS_TTL-232RG_CABLES.pdf)

<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/digital-matter-lorawan003.png')} />
</div>
...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/digital-matter-lorawan004.png')} />
</div>
