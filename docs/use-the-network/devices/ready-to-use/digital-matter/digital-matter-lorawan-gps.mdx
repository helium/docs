...
[Yabby Edge](https://www.digitalmatter.com/our-devices/yabby-edge/) are rugged IP68-rated battery-powered GPS tracking devices.
This guide will show you the hardware and software setup steps required to provision and onboard these devices on the Helium Network.
...
be found at [Wired Provisioning Tool](https://support.digitalmatter.com/support/solutions/articles/16000104317-wired-provisioning-tool).
...
Download the [Oyster3 LoRaWAN Battery Life Estimate Calculator](https://support.digitalmatter.com/helpdesk/attachments/16084686136)
