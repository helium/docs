...
our [quick start for instructions](/use-the-network/console/adding-devices) on how to add a new device to Console.
...
more about this in [our short primer](/use-the-network/console/functions).
