...
description: MCF-LW12TER LoRaWAN Indoor Environmental Sensor
...
The MCF-LW12TER Indoor Environmental Sensor reads the temperature, relative humidity and barometric pressure
and sends collected data over the LoRaWAN network. Ideally suited for a wide range of applications
...
- To ensure correct operation and reliable and consistent measurements, install the MCF-LW12TER sensor away from direct sunlight and heating sources like radiators, conveyors, TV, lights etc. and far away from doors and windows.
