...
description:
  ...
  by Bosch. It measures AQI, CO2 (ppm), VOC (ppm), temperature, humidity and barometric pressure. It also has a
...
The MClimate AQI Sensor and Notifier LoRaWAN is an indoor Air Quality Index Sensor and Notifier with 10+
years of battery life, configurable settings and a beautiful and discrete design. It is a 4-in-1
sensor with gas, humidity, pressure and temperature measurements based on proven sensing principles
