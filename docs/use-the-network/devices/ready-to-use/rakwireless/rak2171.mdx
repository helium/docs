...
<img
  src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak2171/18.choose-network.png'
  )}
/>
...
<img
  src={useBaseUrl(
    'img/use-the-network/devices/ready-to-use/rakwireless/rak2171/19.add-device.png',
  )}
/>
