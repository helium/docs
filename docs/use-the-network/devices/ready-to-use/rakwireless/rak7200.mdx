...
description:  The RAK7200 WisNode Track Lite is an LPWAN Tracker device with a 3.7V rechargeable Li-Ion battery and a GPS modem. It is built around low-power LPWAN Module, which integrates the ultra low power STM32L073 micro-controller, the SX1276 LoRa long-range modem, and the CXD5603GF GPS modem. 
slug: /use-the-network/devices/ready-to-use/rakwireless/rak7200
---
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/RAK7200.png"
  )}
/>
...
- Built-in **9-Axis Sensor**, which includes a triple-axis gyroscope, a triple-axis accelerom/rak7200/eter, and a triple-axis magnetometer.
...
:::tip
Before going through each and every step in connecting the RAK7200 to Helium, it is recommended to check first our [Quick Start Guide](https://docs.rakwireless.com/Product-Categories/WisNode/RAK7200/Quickstart/).
:::
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/1.helium-console.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/2.home.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/3.device-section.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/4.add-device.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/5.registered-device.png"
  )}
/>

Now, your RAK7200 is registered and is awaiting activation. For this to happen, import the **Dev EUI**, **App EUI**, and **App Key** in the RAK7200 using the [RAK Serial Port Tool](https://downloads.rakwireless.com/en/LoRa/Tools/RAK_SERIAL_PORT_TOOL_V1.2.1.zip).
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/6.eui-keys.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7200/7.live-data.png"
  )}
/>
