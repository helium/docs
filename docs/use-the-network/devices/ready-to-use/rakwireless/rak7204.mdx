...
description:
  RAK7204 comes in a compact size that serves as an environmental monitoring station. With its
  high-precision sensors, it can measure changes in temperature, humidity, gas pressure, and indoor
  air quality. All the accumulated data can be sent to the gateway and then forward it to the Cloud.
...
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/RAK7204.png')} />
...
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/1.png')} />
...
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/home.png')} />
...
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/no_dev.png')} />

A window will pop up with a set of field containing the device parameters required for its
registration.

<img
  src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/red_device.png')}
/>
...
<img
  src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/reged_device.png')}
/>
...
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/join.png')} />
...
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/rakwireless/rak7204/joined.png')} />
