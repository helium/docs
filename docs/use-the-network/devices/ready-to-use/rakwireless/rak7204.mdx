...
[The WisNode Sense Home (RAK7204)](https://store.rakwireless.com/products/rak7204-lpwan-environmental-node) is permanently out of stock. As an alternative product, we recommend [RAK WisBlock Weather Monitor Kit](https://store.rakwireless.com/products/wisblock-kit-1-weather-monitor?variant=37637925372102)
