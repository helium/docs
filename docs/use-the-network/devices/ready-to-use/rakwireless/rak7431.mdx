...
description: RAK7431 WisNode Bridge Serial is an RS485 to LoRaWAN converter designed for industrial applications. The device relays ModBUS data using the LoRaWAN network as means of wirelessly transmitting to and from the end-devices.
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7431/RAK7431.png"
  )}
/>
...
:::tip
Before going through each and every step in connecting the RAK7431 to Helium, it is recommended to check first our [Quick Start Guide](https://docs.rakwireless.com/Product-Categories/WisNode/rak7431/Quickstart/).
:::
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7431/2.home.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7431/4.add-device.png"
  )}
/>
...
Now, your RAK7431 is registered and is awaiting activation. For this to happen, import the **Dev EUI**, **App EUI**, and **App Key** in the RAK7431 using the [RAK Serial Port Tool](https://downloads.rakwireless.com/en/LoRa/Tools/RAK_SERIAL_PORT_TOOL_V1.2.1.zip).
...
Run the following AT command for the node to join the network.
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7431/6.eui-keys.png"
  )}
/>
...
<img
  src={useBaseUrl(
    "img/use-the-network/devices/ready-to-use/rakwireless/rak7431/7.live-data.png"
  )}
/>
