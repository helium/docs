...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap.png')} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-certs.png')} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-layout.png')} />
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-internals.png')} />
</div>

<div style={{ textAlign: 'center' }}>Easily removed from enclosures.</div>

<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-mount.png')} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-cable-connector.png')}
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-label.png')} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-new-device.png')} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-switch.png')} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-debug.png')} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-config-tool.png')}
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-console.png')} />
</div>
