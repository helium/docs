...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-cable-connector.png')} />
</div>
...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/seeed-sensecap-config-tool.png')} />
</div>
