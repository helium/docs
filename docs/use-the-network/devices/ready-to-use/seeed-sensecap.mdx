...
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap.png')} />
</div>
...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap-certs.png')} />
</div>
...
### Internals
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap-layout.png')} />
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap-internals.png')} />
</div>
...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap-mount.png')} />
</div>
...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap-cable-connector.png')} />
</div>
...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap-config-tool.png')} />
</div>
...
<div style={{textAlign: 'center'}}>
<img src={useBaseUrl('img/devices/ready-to-use/seeed-sensecap-console.png')} />
</div>
