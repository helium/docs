...
slug: /use-the-network/devices/ready-to-use/victor-trap-v4xx
---
...
If you need any help provisioning this sensor, please join the `#console` channel on [the Helium Discord Server](https://discord.gg/helium).
...
You should have been provided with a DevEUI, AppEUI, and AppKey from your seller,
which are needed to add the device. Follow our [quick start for instructions](/use-the-network/console/quickstart).
...
2. Enter the name for this Integration: _VLINK Integration_
...
Next we'll attach the _VLINK Integration_ label to the device. Navigate to
...
of a Hotspot. See VLINK onboarding instructions [here](https://helium-docs.s3-us-west-2.amazonaws.com/VLINK_Tunnel_Trap_Setup_Instructions.pdf).
