...
<img src={useBaseUrl('img/use-the-network/devices/ready-to-use/victor-trap-v4xx.jpg')} />
...
<img
  src={useBaseUrl('img/use-the-network/devices/ready-to-use/victor-trap-v4xx-http-integration.png')}
/>
