...
slug: /use-the-network/light-hotspots/guides/rak-concentrators
---
# Data Only Hotspot Setup with RAK Concentrator + Raspberry Pi

import useBaseUrl from "@docusaurus/useBaseUrl";

A Data Only Hotspots is a variation of Hotspots that can participate on the
...
they will earn $HTN only for Device Packet Transfer. Remember to keep an eye on
[Light Hotspots Project](https://docs.helium.com/use-the-network/light-hotspots)
...
region = "<region>"
```
Possible values are: `US915 | EU868 | EU433 | CN470 | CN779 | AU915 | AS923 |
KR920 | IN865`.
...
take some minutes before you start to see any activity; wait for a bit of a
while and reset your device if it's needed.
...
[here](http://localhost:3000/mine-hnt/data-only-hotspots#pre-requisites).
