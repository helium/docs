...
- [Cotx gateways](/use-the-network/light-hotspots/guides/cotx)
  - Cotx gateways will only mine HNT as a Data Only Hotspot unless it is
    specified as a Helium-Compatible Cotx Miner.
