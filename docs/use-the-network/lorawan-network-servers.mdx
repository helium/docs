...
## What is the Open LNS Initiative?
...
The Open LNS Initiative (link to open lns page)

## Connect and Manage Devices on Helium

There are a couple options to get started onboarding devices and connecting through a Helium LNS:

### Work with a Professional LNS Service Provider

This is a great option for getting started, and professional hosting companies can provide support
and immediate access to a ready-to-go connectivity platform. LNS Services will vary in price,
support, and features depending on the company. Companies may offer public shared servers, and/or
private servers.

Find a Helium LNS Server Provider. (link to find an lns provider page)
...
Run an LNS. (link to run an lns page)
