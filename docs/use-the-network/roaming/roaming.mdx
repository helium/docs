...
## Getting Started
- **Create an Account**- Contact a Helium Network Advisor to create the initial Helium Roaming Services account (sales@helium.com). Initial setup requires an Organization name, and an email address for the administrator. As part of the initial account creation process, Net ID ownership must be verified for the roaming partner.
