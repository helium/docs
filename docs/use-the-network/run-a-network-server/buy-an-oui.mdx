...
own benchmarking tests. Instructions
...
Please contact [hello@helium.com](mailto:hello@helium.com) to purchase an OUI.
...
2. The Router **misidentify** the offer thinking that it is from `Device9` (as they both share
   ...
   2. If Router does not deem offers associated with `Device9` worthy of purchasing (e.g. maybe
      ...
      out of [Data Credit](/helium-tokens/data-credit)) the offer will be rejected and data never
