...
[Full Description](https://docs.helium.com/wallets/app-wallet/hexagons/). If you are aware of
`H3 Indexes` & `Hexagons` you can skip this.
...
2. The Router **misidentify** the offer thinking that it is from `Device9` (as they both share
   ...
   2. If Router does not deem offers associated with `Device9` worthy of purchasing (e.g. maybe
      ...
      out of [Data Credit](https://docs.helium.com/use-the-network/console/data-credits/)) the offer
      will be rejected and data never delivered. This is a conflict with **non-happy path**.
