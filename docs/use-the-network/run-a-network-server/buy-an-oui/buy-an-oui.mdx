...
currently the OUI itself costs $100 worth of DCs and each NwkAddr cost an
additional $100 in DC.

NwkAddr are sold in sequential blocks between 8 and 65,536 and any power of two.
You must purchase a slab when purchasing an OUI, therefore, the minimum cost for
an OUI is $800 for 8 NwkAddr's and $100 for the OUI itself.
...
but when paying for OUIs and NwkAddr's, the Data Credits must be part of the
purchasers balance.
