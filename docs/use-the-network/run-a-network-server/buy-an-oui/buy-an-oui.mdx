...
The OUI is purchased with data credits (DCs) Costs are subject to change, but
currently the OUI itself cost $100 worth of DCs and each NwkAddr cost an
additional $100 in DC.

NwkAddr are sold in sequential blocks of any power of two between 8 and 65,536.
