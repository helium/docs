...
2. The wallet to be used requires enough HNT to burn for joining the virtual device to the network.
   ...
   - See [Setup Data Only Hotspot](/mine-hnt/data-only-hotspots/#transactions--cost)
...
[instructions](/mine-hnt/data-only-hotspots/) for creating and **funding this wallet**.
