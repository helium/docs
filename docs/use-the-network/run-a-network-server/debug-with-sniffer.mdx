...
You will also need to install [Cmake](https://cgold.readthedocs.io/en/latest/first-step/installation.html).
If some of the following commands fail, try using sudo.
...
[instructions](https://docs.helium.com/mine-hnt/data-only-hotspots/) for creating and **funding this
wallet**.
...
[configuration profiles](https://docs.helium.com/use-the-network/console/profiles/) in Console for
this device, such as `rx_delay`.
