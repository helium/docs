...
[cost of adding data-only hotspots and asserting location](/hotspot-makers/iot/data-only-hotspots)
of each.
...
of 8, and append the resulting value to: `https://explorer-old.helium.com/hotspots/hex/`.)
...
your wallet; see [Data Credits](/helium-tokens/data-credit) within Console documentation.
