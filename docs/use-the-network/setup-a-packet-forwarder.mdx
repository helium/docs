...
an [Full Hotspot](/hotspot-makers/iot/full-hotspots) is not supported.
...
You are now ready to setup the [light hotspot client](/hotspot-makers/iot/light-hotspots).
