...
- **Hotspot Client**: the Helium blockchain comes into the picture here; the hotspot client
...
participate in the Helium Network. The Hotspot Client is designed to send and receive packets
using the Semtech GateWay Messaging Protocol (GWMP), making it compatible with almost every LoRaWAN
...
- the D4H/D4H+/D4HP are all based off of the RAK2287
...
You are now ready to setup the [Hotspot client](/hotspot-makers/iot/light-hotspots).
