...
Neither staked tokens nor the NFT representing a stake can be transfered from one wallet to another.
...
consolidating positions. Landrush positions cannot have more locked tokens transfered into them
...
<figure className="screensnippet-wrapper">
  ...
  <figcaption>A position can be transfered in full or in part.</figcaption>
</figure>
