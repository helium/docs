...
The duration of your cooldown is defined in days. The longer your tokens are staked, the greater the
more veHNT will be issued. If you chose the 'Constant' lockup period, this duration takes affect
...
remember, in this well-done world, it's all about finding the perfect balance to steak your claim. <span className="🥩">🥩</span>
...
transfered. This functionality is useful for consolidating positions. If no other compatabile
