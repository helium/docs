...
align themselves with the long-term health of the Helium Network. This is done by allowing holders to
...
The duration of your cooldown is defined as days. The longer your tokens are staked, the more veHNT
...
Neither staked tokens nor the NFT representing a stake can be transferred from one wallet to another.
...
consolidating positions. Landrush positions cannot have more locked tokens transferred into them
after the landrush period. Any veHNT transferred out of a landrush position will lose the 3x
multiplier bonus.

You must undelegate both positions before transferring a stake between positions. Transferring to a new
