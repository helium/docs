...
the IOT and MOBILE subDAO each have a 6% token emission pool for veHNT stakers. This 6% is shared 
proportionaly amongst all veHNT delegated to that subDAO at the end of each epoch.
