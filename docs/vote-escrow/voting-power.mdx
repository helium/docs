...
id: voting-power
title: Voting Power
pagination_label: Voting Power
sidebar_label: Voting Power
description: Helium Documentation
image: https://docs.helium.com/img/link-image.png
slug: /vote-escrow/voting-power
---
...
Now the Solana migration has completed, stakers can use their staked veHNT to vote on proposals in
the HeliumDAO and help the DAO make collective decisions, influencing the future of the Network.
...
[Staking veHNT on Realms](/vote-escrow/realms) documentation

### Is There a Staking "Genesis" Period?

For the first ten days after Helium's migration onto Solana, there will be a 3x multiplier bonus for
new veHNT stakers. This is called the "Landrush" multiplier.
...
"cliff" mode or after a "constant lockup" is unlocked and cooldown started.
...
undelegate, change the period and redelegate and lose delegation rewards within that 24 hour Epoch.
...
start point will be positive action needed to start the lock-up cooldown period.
