...
end of the lock-up period, any received tokens need to be claimed, the position undelegated, and then
after a close positon action is taken you will receive HNT back to your wallet 1:1 for the HNT you staked.
...
For the first ten days after Helium's migration onto Solana, there was a 3x multiplier bonus for
