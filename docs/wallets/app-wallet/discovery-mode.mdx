...
pagination_label: Discovery Mode
sidebar_label: Discovery Mode
...
Discovery Mode is a discontunted tool for Hotspot owners to understand their Hotspot coverage and
optimize their Hotspot setup.
...
[Discovery Mode also ignores the issue with Relayed Hotspots](/troubleshooting/understanding-witnesses/#relayed-hotspot-as-a-witness).
