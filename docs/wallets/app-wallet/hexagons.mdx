...
<img src={useBaseUrl("img/wallets/helium-app/map-filters.png")} width="600"/>
...
This map layer, when selected, shows yellow hexagons of Hotspots that have witnessed the *selected* Hotspot (outlined in white). 

<img src={useBaseUrl("img/wallets/helium-app/hotspot-app-witnesses-hex.png")} width="200"/>


To view a list of Hotspots that your Hotspot has witnessed, switch to the Witnesses tab.

<img src={useBaseUrl("img/wallets/helium-app/hotspot-app-witnesses.png")} width="200"/>
