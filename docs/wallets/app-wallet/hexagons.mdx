...
# FAQ
1. Q: Why are there hexagons now instead of exact Hotspot locations?
...
2. Q: Why is my Hotspot location so far off from the center of the hexagon?
...
3. Q: Why is my Hotspot so close to its neighboring Hotspot if I asserted 300 meters away?
...
4. Q: Why do Hotspots in a hex have such varied scaling values?
...
5. Q: Are Assert Locations still precise?
