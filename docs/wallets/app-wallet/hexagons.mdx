...
To view a list of your witnessed Hotspots, switch to the Witnesses tab.
...
**Transmit scale is a multiplier that is applied to rewards of *any Hotspot that witness you*. The scale also affects how many rewards you receive as a Challenger.**
