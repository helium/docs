...
<img src={useBaseUrl("img/wallets/helium-app/hotspot-tab-witnesses-hex.png")} width="200"/>


To view a list of Hotspots that your Hotspot has witnessed, switch to the Witnesses tab.

<img src={useBaseUrl("img/wallets/helium-app/hotspot-tab-witnesses.png")} width="200"/>
