...
title: Hotspot Setup Troubleshooting
sidebar_label: Hotspot Setup Troubleshooting
...
- If you have more than one hotspot, or an additional 5V 3A power adapter laying
  ...
  supply or if something else is the issue.
...
If there's no lights or activity after these steps, please contact us at
support@helium.com and include the MAC address listed on the bottom of the
device and we can work with you to get the unit sent in for further diagnosis.
Note that we are only able to RMA Hotspots that are under warranty and purchased
directly through Helium.com

## I can't Pair the hotspot with the App:

- Double check that the phones bluetooth settings are enabled. Once enabled,
...
- Try power-cycling the Hotspot by unplugging it, waiting 10 seconds, and
  ...
  again. If you still have trouble after trying these things, please feel free
  to email support@helium.com and we can troubleshoot further with you. It's
...
If you still have trouble and are able to run the diagnostics, please send that
to support@helium.com. Please include a video of your screen if possible, to
