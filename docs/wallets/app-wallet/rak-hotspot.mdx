...
8. Confirm Hotspot Location and set antenna details. This is free for the first assertion (while you will see the transaction fee in the app, it is paid for by the manufacturer). The transaction fee is paid by you for each additional assert.  If you are not ready to set a location, you can do so later by pressing Skip for now. If you do not see fee-free location, please contact support@helium.com. Press Continue.
