...
- This feature is only available on app version 2.8.0 or newer. Both parties
  must have 2.8.0 or newer for Transfer Hotspots to succeed. 
* Parties do not need
...
- This feature requires both users to have a valid Helium wallet account and the
  ...
  transaction fee which is typically 10,055,000 DC.
...
<img src={useBaseUrl("img/wallets/helium-app/transfer-entry.png")} />
...
<img src={useBaseUrl("img/wallets/helium-app/transfer-send-confirm.png")} />
...
<img src={useBaseUrl("img/wallets/helium-app/transfer-notification.png")} />


<img src={useBaseUrl("img/wallets/helium-app/transfer-complete-transaction.png")} />
...
If you're on 2.8.0 or later, you may need to sign out of the app and sign back in with your 12 words.
**Before you do this, make sure your 12 words are written down and correct. Verify on by tapping on More > Reveal Words in the app.**
