...
2. Acknowledge that you, the Seller, will no longer own or earn mining rewards from
...
5. Press Send Transfer Request to submit the Transfer. The transfer request will be automatically submitted.
* Note that once submitted, transfers can not be cancelled, reversed, or changed.  Having the correct Buyer address is critical*

6. Once the Transfer Hotspot transaction clears the blockchain, the Hotspot will
   no longer appear in the Sellers account and will show up in the Buyers account. Both the Buyer and Seller will
...
Once the the transaction clears, a notification will appear in the Buyer’s notification center.  The Hotspot will then show up in the Buyers wallet.
Tap on the notification to view the transaction.
...
This cannot be cleared as all history is from the ledger.  It does not transfer any previously earned HNT.
