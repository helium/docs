...
24 words. If a Hotspot is transferred to a 24-words wallet, you can use the
[Wallet CLI](/wallets/cli-wallet) to transfer the Hotspot to a 12-words wallet.
...
- This feature requires both users to have a valid Helium wallet account. Remember, 24-words wallets
