...
It is now recommended to use version 2.0.0 or higher of the
[Helium Wallet app](/wallets/helium-wallet-app) to perform hotspot transfers between wallets. This
app has no restrictions on the transfer
