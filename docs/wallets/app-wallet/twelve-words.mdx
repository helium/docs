...
When setting up a Helium wallet through the Helium Hotspot app, you are prompted to write down the 12 words seed
phrase. These are the mnemonic phrase generated from the private key of your wallet, and the only
way to access the wallet.

The 12 word seed can be used or imported on both the [Helium Hotspot APP](https://docs.helium.com/wallets/app-wallet) and the [Helium Wallet APP](https://docs.helium.com/wallets/helium-wallet-app).
You cannot import a 24 word seed phrase in the Helium Hotspot App, these will only work in the Helium Wallet Aapp.
Hotspots sent to a 24 word wallet can only be managed/transfered by the hotspot vendor's app or the cli-wallet.
...
A friendly reminder about those 12 words… When you first created an account in the Helium Hotspot App, those
...
words, and you lose your access to your HNT and your hotspots and their future earnings. No-one can help you recover them.

Luckily, there’s an easy way to back up those 12 words. Write them down, save it, and back it up. Go
to the Helium Hotspot App > … menu > Reveal Words.
...
No Helium Support or Admin person will EVER ask for your 12 or 24 words or ask you to enter them into a website to
fix a problem.
...
2. Imagine they are cash, never give them to anyone you would not trust with the HNT value and
   Hotspot value.
3. Do not enter these in any app or website not in the list of 4 above. Even vendor apps.
