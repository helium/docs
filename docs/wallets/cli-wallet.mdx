...
If you have a wallet from before the migration to Solana (April 18th, 2023), you can migrate it using this widget:

import { MigrateWallet } from '@theme/MigrateWallet'

<MigrateWallet />

Once this is done, the wallet should work on Solana. You can see a mapping from the Helium L1 address to the Solana Address:
