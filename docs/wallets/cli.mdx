...
- [add and assert data only hotspot](/network-iot/hotspots-iot/data-only-hotspots)
...
- [Helium Wallet App](/helium-wallet-app) version `1.3.0` or later, available for
...
1. Create a 12-word Wallet to receive the Hotspot using the [Helium Wallet App](/helium-wallet-app)
   and record the Public Key.

2. Download and install the [Helium Command Line Wallet](/cli-wallet#installing-cli-wallet) as
   outlined above. and navigate to the installation directory.
...
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `create basic`                   | create a Wallet with a single key, as opposed to a [sharded wallet](/cli-wallet#sharded-wallet)                  |
