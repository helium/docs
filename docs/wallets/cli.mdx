...
At time of this writing, version 1.7.5 looks like this:
...
helium-wallet-create-basic 1.7.5
...
- `helium-wallet-rs version 1.7.5` or later, available
...
- Helium Wallet App must have `Developer Mode` turned `On`.
...
<div class="container" style={{ padding: 0, paddingTop: 0 }}>
  <div class="row">
    ...
    <div class="col col--6" style={{ marginBottom: 0 }}>
      ...
      <p>
        Remember that you must first toggle on <code>Developer Mode</code> in Settings.
      </p>
    </div>
  </div>
  <hr></hr>
