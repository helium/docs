...
Nano X users need to have Bluetooth connectivity to use the app.
...
Helium blockchain migrated to Solana blockchain. The migration to Solana took place on April 18, 2023, beginning at 9am PST. If you used the Helium Ledger app before the migration date, please refer to [this guide](https://docs.helium.com/solana/migration/ledger/) to complete your migration.
...
Now that you're done with the set-up process, you can manage tokens or hotspots using your Ledger account. There's a "Send" or "Request" icon in the app. You can select Request and ensure your correct Ledger public key appears.

After selecting Request, a QR code will pop up. You can use this code to send tokens to your account.
