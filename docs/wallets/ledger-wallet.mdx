...
If the migration tool does not work for you, the best option is to import the seed phrase
from your Ledger into the official [Helium Wallet App](https://docs.helium.com/wallets/helium-wallet-app).
You can then transfer your tokens from the app to a new hardware wallet with a new seed phrase.
