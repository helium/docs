...
:::info Ledger CLI using experimental mode is supported at this time. Work to
enable HNT in Ledger Live in addition to a CLI is ongoing. :::
...
:::info If you can't find "Helium", you may need to update your Ledger Live. :::
...
:::info Make sure Ledger Live is closed before proceeding! The companion app
...
:::warning Do not simply rely on what you see on the CLI, but verify it matches
what is displayed on the Ledger. :::

:::info You may add the `--qr` option to the command to display your address in
...
:::info Up to 255 wallets may be used on the Ledger, but the `--scan` command
...
:::warning Use the screen of the Ledger to confirm everything you do. The CLI
