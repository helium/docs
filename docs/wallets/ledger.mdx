...
If you cannot find "Helium", you may need to update your Ledger Live.
...
(i.e.: call the specific `--account N balance` without the `--scan` option) before sending any assets.
...
Use the link displayed to check your transaction status.
