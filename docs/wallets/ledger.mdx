...
:::info
Ledger CLI using experimental mode is supported at this time. Work to enable HNT in Ledger Live in addition to a CLI is ongoing.
:::
...
:::info
You may add the `--qr` option to the command to display your address in
