...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  {/* <div style={{ maxWidth: '450px' }}>![Bitflip Drain](./previews/bitflip-drain.png)</div> */}
</div>

Given this preview, it's not clear that you are getting rugged. Your accounts are labeled as
writable, bt they do not change in simulation.
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  {/* <div style={{ maxWidth: '450px' }}>![Simulation Failed](./previews/simulation-failed.png)</div> */}
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  {/* <div style={{ maxWidth: '450px' }}>![Smoke Screen](./previews/smoke-screen.png)</div> */}
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  {/* <div style={{ maxWidth: '450px' }}>![Delegate](./previews/delegate.png)</div> */}
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  {/* <div style={{ maxWidth: '450px' }}>![Owner Change](./previews/owner-change.png)</div> */}
</div>
...
the scammer's dust transacion. NOT your testing transaction.
