...
the mnemonic phrase generated from the private key of the wallet and the only way to access the
wallet.

:::info Hotspot App Users must migrate to the Helium Wallet app.

Long term Helium Hotspot app users may have a 12-word seed phrase, these can be used in place of
24-word seed phrases. All new Helium Wallets are generated from a 24-word seed phrase.
