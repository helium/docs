...
Long term Helium Hotspot App users may have a 12-word seed phrase, which can be used in place of
a 24-word seed phrase. All new Helium Wallets are generated from a 24-word seed phrase.
...
Do not log out of a phone Wallet or uninstall the Helium Wallet App without first writing down the
seed phrase.
...
2. Never give seed phrase words to anyone who cannot be trusted with the HNT value and Hotspot
   value.
...
Seed phrases generated to create Wallets on the Helium blockchain cannot be used on the Solana
