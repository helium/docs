...
never needed to diagnose a Hotspot or verify on-chain transaction.
...
If you have not accessed your wallet since the blockchain migration to Solana completed on April 19,
2023, please refer to the [Wallet User Migration Guide](/solana/migration/wallet-user).
