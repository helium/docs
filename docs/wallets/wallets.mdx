...
The existing [Helium Hotspot app](/wallets/app-wallet) will be restricted to only the management of
...
1. Export Seed Phrase to import into a Solana CLI Wallet (or the Helium Wallet app)
