module.exports = {
  ...
  api: [
    'api/home',
   {
      type: 'category',
      label: 'Blockchain',
      items: ['api/blockchain/introduction', 'api/blockchain/stats', 'api/blockchain/blocks', 'api/blockchain/accounts', 'api/blockchain/validators', 'api/blockchain/hotspots', 'api/blockchain/cities', 'api/blockchain/locations', 'api/blockchain/transactions', 'api/blockchain/pending_transactions', 'api/blockchain/oracle_prices', 'api/blockchain/chain_variables', 'api/blockchain/ouis', 'api/blockchain/rewards', 'api/blockchain/dc_burns', 'api/blockchain/state_channels', 'api/blockchain/assert_locations'],
      collapsed: true,
    },
    'api/console',
  ],
