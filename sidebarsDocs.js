  ...
  validators: [
   {
    ...
    },
    {
      type: 'category',
      label: 'Validators',
      items: ['mine-hnt/validators/requirements', 'mine-hnt/validators/validator-wallet', 'mine-hnt/validators/validator-tnt', 'mine-hnt/validators/validator-run', 'mine-hnt/validators/validator-monitor', 'mine-hnt/validators/validator-troubleshooting', 'mine-hnt/validators/validator-testcases','mine-hnt/validators/validator-deployment-guide'],
      collapsed: false,
    },
  ],
  bL072zLrwan1: [
