module.exports = {
  docs: [
    ...
    },
    {
      ...
      items: ['use-the-network/use-the-network', 'use-the-network/devices/devices', 'use-the-network/console/console', 'use-the-network/run-a-network-server/run-a-network-server', 'use-the-network/community-projects/community-projects', 'use-the-network/coverage-mapping/coverage-mapping', 'use-the-network/build-a-packet-forwarder/build-a-packet-forwarder'],
      collapsed: true,
    },
    {
      type: 'category',
